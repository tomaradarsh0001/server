            ...
            if (isset($request->purposeReg)) {
                ...
                if (isset($request->newUser)) {
                    ...
                    if ($request->newUser == 'propertyowner') {
                        ...
                        $isIndian = $request->isIndianOrg ? true : false;
                        $documentType = $request->documentTypeOrg ? $request->documentTypeOrg : '';
                        ...
                        if (empty($ismobileEmailAvailable)) {
                            ...
                            if ($isEmailMobileVeified) {
                                ...
                                $userRegistration = UserRegistration::create([
                                    ...
                                    'documentTypeNumber' => $documentTypeNumber ? $documentTypeNumber : '',
                                    'user_remark' => $remark,
            ...
            if (isset($request->mobileOtp)) {
                ...
                if ($minutesDifference < config('constants.OTP_EXPIRY_TIME')) {
                    ...
                    if ($databaseOtp) {
                        ...
                        if ($databaseOtp->save()) {
                            return response()->json(['success' => true, 'message' => 'Mobile number ' . $request->mobile . ' verified successfully', 'showUploadDocumentField' => $showUploadDocumentField]);
                        } else {
                            return response()->json(['success' => false, 'message' => 'Mobile number not verified', 'showUploadDocumentField' => false]);
                        }
                    } else {
                        return response()->json(['success' => false, 'message' => 'Otp not matched. Please enter correct otp', 'showUploadDocumentField' => false]);
                    }
                } else {
                    return response()->json(['success' => false, 'message' => 'Otp has been expiered. Please resend again', 'showUploadDocumentField' => false]);
                }
                ...
                if ($minutesDifference < config('constants.OTP_EXPIRY_TIME')) {
                    ...
                    if ($databaseOtp) {
                        ...
                        if ($databaseOtp->save()) {
                            return response()->json(['success' => true, 'message' => 'Email ' . $request->email . ' verified successfully', 'showUploadDocumentField' => $showUploadDocumentField]);
                        } else {
                            return response()->json(['success' => false, 'message' => 'Email not verified', 'showUploadDocumentField' => false]);
                        }
                    } else {
                        return response()->json(['success' => false, 'message' => 'Otp not matched. Please enter correct otp', 'showUploadDocumentField' => false]);
                    }
