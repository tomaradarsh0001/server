    ...
    public function index()
{
    ...
    foreach ($emails as $email) {
        $item = Item::where('item_code', $email->action)->first();
        $items[$email->id] = $item ? $item->getItemNameByItemCode($email->action) : 'Default';
    }
    return view('settings.mail.index', compact('emails', 'items'));
}
