...
class ApplicationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $items = getApplicationStatusList(true, true);
        $appTypeItems = getApplicationTypeList();
        return view('admin.applications.index', compact('items', 'getStatusId', 'user', 'applicationType', 'appTypeItems', 'getApplicationTypeId'));
    }
    ...
    public function getApplications(Request $request)
    {
        ...
        foreach ($applications as $key => $application) {
            ...
            if (Auth::user()->roles[0]->name == 'section-officer' && getServiceCodeById($application->status) == 'APP_NEW') {
                if (!empty($userCurrentApplication) && in_array($application->application_no, $userCurrentApplication)) {
    ...
    public function applicationCanView(Request $request)
    {
        ...
        if ($isOfficeViewTheApplication['canView']) {
            ...
            return response()->json([
                'canView' => false,
                'message' => 'Older application ' . $isOfficeViewTheApplication['currentActionableApplicationNo'] . ' is pending, please process it first.'
            ]);
        }
    }
	...
	$lesseeNames = [];
        ...
        $lesseeNames = implode(' and ', $lesseeNames);
        $transferDate = array_unique($transferDate);
        $noticeData = [
    ...
    public function applicationsDisposed(Request $request)
    {
        ...
        $appTypeItems = getApplicationTypeList();
        return view('admin.applications.disposed', compact('items', 'getStatusId', 'user', 'applicationType', 'appTypeItems', 'getApplicationTypeId'));
    }
