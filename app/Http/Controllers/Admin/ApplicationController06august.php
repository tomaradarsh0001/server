...
/*    public function getApplications(Request $request)
    {
        ...
        foreach ($applications as $key => $application) {
            ...
            $nestedData['created_at'] = date('d-m-Y H:i:s',strtotime($application->created_at));
            $nestedData['latest_moved_at'] = date('d-m-Y H:i:s',strtotime($application->latest_moved_at));
            $data[] = $nestedData;
        }
