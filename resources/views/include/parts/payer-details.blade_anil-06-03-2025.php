    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-3">
            <div class="form-group">
                ...
                <input type="text" name="payer_mobile" id="payer_mobile" class="form-control" placeholder="Mobile No." required pattern="^[1-9][0-9]{9}$" ttile="please enter 10 digit value">
            </div>
        </div>
        <div class="col-lg-3 mb-3">
            <div class="form-group">
...
<div class="row d-none mt-5 mb-3 payment-mode" id="row-payment-mode">
    ...
    <div class="col-lg-3">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="payment_mode" value="PAY_OFFLINE" id="mode_offline">
