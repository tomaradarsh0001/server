...
if (!function_exists('customNumFormat')) {
	...
	{
		// return utf8_encode(money_format('%!i', $num));
		if ($num < 1000) {
			return $num;
		} else {
			$numParts = [];
			...
			return $intPart . ',' . implode(',', array_reverse($numParts));
		}
	}
}
?>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark" style="font-size:2rem;">₹{{customNumFormat(round($lh_land_val, 2))}}</h4>
						<p class="mb-0 text-secondary">Total Land Value (LH)</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 text-dark grid-icons-size" style="font-size:2rem;">₹{{customNumFormat(round($fh_land_val, 2))}}</h4>
						<p class="mb-0 text-secondary">Total Land Value (FH)</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($statusCount['lease_hold'])}}</h4>
						<p class="mb-0 text-secondary">Lease Hold</p>
						<p>({{customNumFormat(round($statusArea['lease_hold']))}} sqm)</p>
