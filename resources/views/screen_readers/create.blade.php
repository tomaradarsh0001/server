    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">               
                        <form class="forms-sample" method="POST" action="{{ route('screen-readers.store') }}">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="screen_reader_eng" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Screen Reader (Hindi)</label>
                                <input type="text" name="screen_reader_hin" class="form-control" required>
                            </div>
                            <div class="mb-3">
