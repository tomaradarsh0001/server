                            ...
                            <div class="col-sm-6 col-xl-4 col-lg-6">
                                <div class="card o-hidden border-0">
                                    <div class="bg-primary b-r-4 card-body">
                                        <a href="{{ route('regiserUserListings', ['status' => Crypt::encrypt('RS_NEW')]) }}">
                                            <div class="widget-media">
                                                ...
                                                <div class="widget-media-body">
                                                    ...
                                                    <h4 class="mb-0 counter"><span id="reg-newCount"> {{ $registrations['newCount'] }}</span></h4>
                                                    <i class="fa-solid fa-user-plus"></i>
                                                </div>
                                            </div>
                                        </a>
                            ...
                            <div class="col-sm-6 col-xl-4 col-lg-6">
                                <div class="card o-hidden border-0">
                                    <div class="bg-reddis b-r-4 card-body">
                                        <a href="{{ route('regiserUserListings', ['status' => Crypt::encrypt('RS_PEN')]) }}">
                                            <div class="widget-media">
                            ...
                            <div class="col-sm-6 col-xl-4 col-lg-6">
                                <div class="card o-hidden border-0">
                                    <div class="bg-light-green b-r-4 card-body">
                                        <a href="{{ route('regiserUserListings', ['status' => Crypt::encrypt('RS_APP')]) }}">
                                            <div class="widget-media">
                                                <div class="align-self-center text-center widget-media-icon">
                            ...
                            <div class="col-sm-6 col-xl-4 col-lg-6">
                                <div class="card o-hidden border-0">
                                    <div class="bg-secondary b-r-4 card-body">
                                        <a href="{{ route('regiserUserListings', ['status' => Crypt::encrypt('RS_REJ')]) }}">
                                            <div class="widget-media">
                                                <div class="align-self-center text-center widget-media-icon">
                                                    <i class="fa-solid fa-trash-arrow-up"></i>
                                                </div>
                ...
                <div class="card widget-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                @php
                                    $additionalData = !is_null($status->additional_data) ? json_decode($status->additional_data):null;
                            ...
                            <div class="col-sm-6 col-xl-4 col-lg-6">
                                <div class="card o-hidden border-0">
                                    <div class="{{$color}} b-r-4 card-body">
                                        <a href="{{ $status->item_name == 'Disposed' ? route('applications.disposed') : route('admin.applications', ['status' => Crypt::encrypt(" $status->item_code")]) }}">
                                            <div class="widget-media">
                                                <div class="align-self-center text-center widget-media-icon">
                                                ...
                                                <div class="widget-media-body">
                                                    ...
                                                    <h4 class="mb-0 counter" id="total-{{ $status->item_code }}">{{ isset($statusWiseCounts[$status->item_code]) ? $statusWiseCounts[$status->item_code] : 0 }}</h4>
                                                    <i class="fa-solid {{$icon}}"></i>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="added-properties-content">
                                        ...
                                        <div class="item-cards-col">
                                            ...
                                            <h3 class="item-cards-count" id="new-prop-urewCount">
                                                <span class="badge badge-underreview counter">{{ $newProperty['urewCount'] }}</span>                                            
                                            </h3>
                                        </div>
