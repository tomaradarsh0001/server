...
<div class="container-fluid">
    ...
    <div class="row row-cols-2 row-cols-md-2 row-cols-xl-2 custom_card_container  outside-tiles">
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        ...
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark view-list" id="outside_count"
                                data-filter-value="unalloted">{{customNumFormat($outsideProperty['count'])}}</h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin"><img src="{{asset('assets/images/pageless-OD.svg')}}"
                                alt="Pageless">
                        </div>
...
<div class="row row-cols-2 row-cols-md-2 row-cols-xl-6 custom_card_container">
    ...
    <div class="col">
        <div class="card radius-10 border-start border-0">
            <div class="card-body">
                <div class="text-center">
                    <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color:#fde7e6;"> <!-- added bg color by anil on 24-03-2025 -->
    ...
    <div class="col">
        <div class="card radius-10 border-start border-0">
            <div class="card-body">
                <div class="text-center">
                    <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color:#e2eff5;"> <!-- added bg color by anil on 24-03-2025 -->
    ...
    <div class="col">
        <div class="card radius-10 border-start border-0">
            <div class="card-body">
                <div class="text-center">
                    <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color: #d6eff1;"> <!-- added bg color by anil on 24-03-2025 -->
    ...
    <div class="col">
        <div class="card radius-10 border-start border-0">
            <div class="card-body">
                <div class="text-center">
                    <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color: #f5e2d5;"> <!-- added bg color by anil on 24-03-2025 -->
                                            ...
                                            <table class="table align-middle table-striped m-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('outStandingDuesList',['propertyStatus'=>'951'])}}" target="_blank">{{customNumFormat($oldDemandData['leaseHold']->property_count)}}</a></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('outStandingDuesList',['propertyStatus'=>'952'])}}" target="_blank">{{customNumFormat($oldDemandData['freeHold']->property_count)}}</a></td>
                                                    </tr>
