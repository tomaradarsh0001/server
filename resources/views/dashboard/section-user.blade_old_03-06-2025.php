    ...
    <div class="container-fluid">
        ...
        <!-- <div class="container-fluid general-widget">
            <div class="row">
                <div class="col-12">
                    <h4 class="mt-4">
                        <a href="{{ route('regiserUserListings') }}" style="color: inherit">Total Registrations:
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xl-3 col-lg-6">
                    <div class="card o-hidden border-0">
                        <div class="bg-deer b-r-4 card-body">
                            <div class="widget-media">
                                <div class="align-self-center text-center widget-media-icon"><i class="fa-solid fa-hourglass-half"></i></div>
                                <div class="widget-media-body"><span class="m-0">Pending</span>
                                    <h4 class="mb-0 counter">3</h4><i class="fa-solid fa-hourglass-half"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-xl-3 col-lg-6">
                    <div class="card o-hidden border-0">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="widget-media">
                                <div class="align-self-center text-center widget-media-icon"><i class="fa-solid fa-bars-progress"></i></div>
                                <div class="widget-media-body"><span class="m-0">Under Review</span>
                                    <h4 class="mb-0 counter">2</h4><i class="fa-solid fa-bars-progress"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <h4 class="mt-4">
                        <a href="{{ route('regiserUserListings') }}" style="color: inherit">Total Applications:
                            <span id="reg-totalCount">{{ $totalAppCount }}</span>
                        </a>
                    </h4>
                </div>
            </div>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="widget-media">
                                ...
                                <div class="widget-media-body">
                                    <span class="m-0">New Application</span>
                                    <h4 class="mb-0 counter">21</h4>
                                    <i class="fa-solid fa-user-plus"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-deer b-r-4 card-body">
                            <div class="widget-media">
                                <div class="align-self-center text-center widget-media-icon"><i class="fa-solid fa-hourglass-half"></i></div>
                                <div class="widget-media-body"><span class="m-0">Pending</span>
                                    <h4 class="mb-0 counter">0</h4><i class="fa-solid fa-hourglass-half"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-primary b-r-4 card-body">
                            <div class="widget-media">
                                ...
                                <div class="widget-media-body"><span class="m-0">In Progress</span>
                                    <h4 class="mb-0 counter">15</h4><i class="fa-solid fa-bars-progress"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row separate-col-border">
                                            @foreach ($statusList as $i => $status)
                                                <div class="custom-col-col col-4 col-lg-2">
                                                    ...
                                                    @else
                                                        <a href="{{ route('admin.applications', ['status' => Crypt::encrypt(" $status->item_code")]) }}">
                                                            <span class="dashboard-label">{{ $status->item_name }}:</span>
                                                            <span id="total-{{ $status->item_code }}">{{ isset($statusWiseCounts[$status->item_code]) ? $statusWiseCounts[$status->item_code] : 0 }}</span></a>
                                                    @endif
                                                </div>
                                            @endforeach
                                        </div>
                    ...
                    <div class="card pinkcard addedproperties">
                        <div class="card-body">
                            <div class="dashboard-card-view temp_design">
                                <h4><a href="{{ route('applicantNewProperties') }}" style="color: inherit">Added
                                        Properties:
