        ...
        <div class="card-body">
            ...
            <form id="filter-form" method="get" action="{{ route('customizeReport') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3 mb-3" id="sectionDiv" style="display: none;">
                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-4 d-flex align-items-end gap-2 mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#apply-btn').on('click', function() {
                ...
                if (reportType) {
                    ...
                    if (columns) {
                        // Check if Serial Number column already exists to avoid duplication
                        if (!columns.some(col => col.title === 'S.NO.')) {
                            columns.unshift({
                                data: null,
                                title: 'S.NO.',
                                orderable: false,
                        ...
                        // Create table header dynamically including Serial Number
                        var thead = '<thead><tr>';
                        ...
                        $('#reportTable').DataTable({
                            ...
                            columns: columns,
                            // You can uncomment the following DOM and buttons block if needed
                            /*
                        ...
                        // added this function for add new div by js for make table responsive with horizantal scroll by anil on 10-09-2025
                        $('#reportTable').on('init.dt', function () {
                            if ($("#customDiv").length === 0) {
                                $('#reportTable').parent().wrap('<div id="customResponsive" class="table-responsive mt-2"></div>');
                            }
                        });
                        // added this function for add new div by js for make table responsive with horizantal scroll by anil on 10-09-2025
                    } else {
        ...
        $(document).ready(function() {
            function updateLayout() {
                ...
                // var classSecond = 'col-lg-2'; //chnages by anil on 28-08-2025
                var classSecond = 'col-md-2 mb-3'; //chnages by anil on 28-08-2025
            ...
            try {
                ...
                switch (reportType) {
                    case 'SWPC':
                        ...
                        headers = ['S. No.', 'SECTION NAME', 'NUMBER OF PROPERTIES'];
                    ...
                    case 'CLHFHUA':
                        ...
                        headers = ['S. No.', 'COLONY NAME', 'LEASE HOLD', 'FREE HOLD', 'UNALLOTTED', 'TOTAL'];
                        rows = data.map((item, index) => [
                            index + 1,
                            item.colony_name,
                    ...
                    case 'TWPC':
                        ...
                        headers = ['S. No.', 'PROPERTY TYPE', 'NUMBER OF PROPERTIES'];
                        rows = data.map((item, index) => [
                            index + 1,
                            item.property_type,
                            item.number_of_properties
