        ...
        <!-- New design for Property Document Details- SOURAV CHAUHAN (09/Jan/2025) -->
                    ...
                    <div class="col-lg-12">
                        <table class="table table-bordered particular-document-table">
                            ...
                            <tbody>
                                ...
                                if (
                                isset($document['isFirstInput']) &&
                                $document['isFirstInput'] == false
                                ) {
                                $documentLabel = array_values($document['inputs'])[0]['label'];
                                $firstInputLabel = 'Type of Document';
                                }
                                @endphp
                                    @foreach ($uploadedDocuments as $ud)
                                        <tr>
                                            <td>{{ ++$counter }}</td>
                                            <td>
                                                <span class="doc-name">{{ $documentLabel }} <a
