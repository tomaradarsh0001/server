...
<div class="col-lg-12">
    <div class="form-group">
        ...
        <textarea rows="4" class="form-control" name="additionalRemark" id="remarks" placeholder="Remarks" data-listener-added_5916a0ef="true" spellcheck="false" required></textarea>
