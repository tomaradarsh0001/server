<div class="mt-3">
    <div class="container-fluid g-0">
        ...
        <div class="row g-2">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutAgeApp" class="form-control numericOnly" id="mutAgeApp"
        ...
        <div class="row g-2 mt-2">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutRegnoAsConLease" class="form-control numericOnly" id="regno"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutBooknoAsConLease" class="form-control numericOnly" id="bookno"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutVolumenoAsConLease" class="form-control numericOnly"
                        id="volumeno" placeholder="Volume Number"
                    ...
                    <div class="row merge-inputs">
                        <div class="col-lg-6">
                            <input type="text" name="mutPagenoFrom" class="form-control numericDecimalHyphen"
                                id="pagenoFrom" placeholder="From" value="{{ $num1 }}">
                            <div id="pagenoFromError" class="text-danger text-left"></div>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" name="mutPagenoTo" class="form-control numericDecimalHyphen"
                                id="pagenoTo" placeholder="To" value="{{ $num2 }}">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap ">
                    @foreach ($documentTypes as $document)
                        <div class="form-check form-check-success">
                            @if (isset($application))
                                <input name="{{ $document->color_code }}_check" class="form-check-input documentType"
                                    type="checkbox" value="{{ $document->item_code }}"
                                    id="{{ $document->color_code }}_check"
                                    @if (in_array($document->item_code, $decodedDocuments)) checked onclick="return false" @endif>
                            @else
                                <input name="{{ $document->color_code }}_check" class="form-check-input documentType"
                                    type="checkbox" value="{{ $document->item_code }}"
                                    id="{{ $document->color_code }}_check">
        ...
        <div class="row g-3 align-items-end mt-3">
            ...
            <!-- commented by anil no need for this code 09-04-2025 -->
            <!-- <div class="row g-3 align-items-end mt-3">
                <div class="col-lg-6">
                    <div class="d-flex align-items-center">
