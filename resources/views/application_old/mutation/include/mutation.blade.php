<div class="mt-3">
    <div class="container-fluid g-0">
        ...
        <div class="row g-2">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutNameApp" class="form-control alpha-only" id="mutNameApp"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutGenderApp" class="form-control alpha-only" id="mutGenderApp"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <div class="mix-field">
                        <input type="date" id="mutDateOfBirth" name="dateOfBirth" max="{{ date('Y-m-d') }}"
                            class="form-control" readonly />
                        <div class="age-box">
                            <h4>Age: </h4>
                            <input type="text" id="mutAge" name="age" class="form-control" placeholder="0"
                                readonly />
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="input-group mb-3"> <span class="input-group-text" style="border-radius: 0;"
                        id="mutprefixApp"></span>
                    <input type="text" name="mutFathernameApp" id="mutFathernameApp" class="form-control alpha-only"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutMobilenumberApp" class="form-control numericOnly"
                        id="mutMobilenumberApp" maxlength="10" placeholder="Mobile Number" readonly>
                </div>
            </div>
        </div>
        <!-- row end -->
        ...
        <div class="row g-2 mt-2">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="namergapp" class="form-label">Executed in Favour of<span
                            class="text-danger">*</span></label>
                    <input type="text" name="mutNameAsConLease" class="form-control alpha-only" id="namergapp"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="date" name="mutExecutedOnAsConLease" class="form-control"
                        id="mutExecutedOnAsConLease" placeholder="Executed on"
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <i class="bi bi-info-circle-fill text-primary qmark" data-toggle="tooltip" data-placement="top"
                        title="Registration No. is given by the sub-registrar at the time of registration of the property. It is mentioned on the document with Registration details."
                        data-bs-custom-class="tooltip-info">
                        <span class="qmark">&#8505;</span>
                    </i>

                    <input type="text" name="mutRegnoAsConLease" maxlength="30" class="form-control numericOnly"
                        id="regno" placeholder="Registration Number"
                        value="{{ isset($application) ? $application->reg_no_as_per_lease_conv_deed : '' }}">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <i class="bi bi-info-circle-fill text-primary qmark" data-toggle="tooltip" data-placement="top"
                        title="Book No. is mentioned on the document with Registration details."
                        data-bs-custom-class="tooltip-info">
                        <span class="qmark">&#8505;</span>
                    </i>
                    <input type="text" name="mutBooknoAsConLease" maxlength="10" class="form-control numericOnly"
                        id="bookno" placeholder="Book Number"
                        value="{{ isset($application) ? $application->book_no_as_per_lease_conv_deed : '' }}">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <i class="bi bi-info-circle-fill text-primary qmark" data-toggle="tooltip" data-placement="top"
                        title="Volume No. is mentioned on the document with Registration details."
                        data-bs-custom-class="tooltip-info">
                        <span class="qmark">&#8505;</span>
                    </i>
                    <input type="text" name="mutVolumenoAsConLease" maxlength="10"
                        class="form-control numericOnly" id="volumeno" placeholder="Volume Number"
                        value="{{ isset($application) ? $application->volume_no_as_per_lease_conv_deed : '' }}">
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div class="row merge-inputs">
                        <div class="col-lg-6">
                            <input type="text" name="mutPagenoFrom" maxlength="4"
                                class="form-control numericDecimalHyphen" id="pagenoFrom" placeholder="From"
                                value="{{ $num1 }}">
                            <div id="pagenoFromError" class="text-danger text-left"></div>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" name="mutPagenoTo" maxlength="4"
                                class="form-control numericDecimalHyphen" id="pagenoTo" placeholder="To"
                                value="{{ $num2 }}">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="regdate" class="form-label">Registration Date<span
                            class="text-danger">*</span></label>
                    <input type="date" name="mutRegdateAsConLease" class="form-control" id="regdate"
                        value="{{ isset($application) ? $application->reg_date_as_per_lease_conv_deed : '' }}">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap ">
                    @foreach ($documentTypes as $document)
                        <div class="form-check form-check-success">
                            @if (isset($application))
                                <input class="form-check-input documentType" type="checkbox"
                                    value="{{ $document->item_code }}" id="{{ $document->color_code }}_check"
                                    @if (in_array($document->item_code, $decodedDocuments)) checked @endif>
                            @else
                                <input class="form-check-input documentType" type="checkbox"
                                    value="{{ $document->item_code }}" id="{{ $document->color_code }}_check">
                            @endif
                            <label class="form-check-label" for="{{ $document->color_code }}_check">
                                {{ $document->item_name }}
                            </label>
                        </div>
                    @endforeach
        ...
        <div class="row g-3 align-items-end mt-3">
            ...
            <div class="col-lg-6" id="mortgagedMainDivMutation" style="display: none;">
                <div class="d-flex align-items-center">
                    ...
                    <div class="form-check mr-5">
                        <input class="form-check-input" name="mutPropertyMortgaged" type="radio" value="1"
                            id="YesMortgaged"
            ...
            <div id="yesRemarksDiv"
                style="{{ isset($application) && $application->property_stands_mortgaged == 1 ? '' : 'display:none' }}">
                <!-- <div class="col-lg-4">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="remarks" class="form-label">Remark<span class="text-danger">*</span> (Mention
                            details of NOC from mortgaged bank/ authority, submit original NOC at the time of proof
                            reading. )</label>
