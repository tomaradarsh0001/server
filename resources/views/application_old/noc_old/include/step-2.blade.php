                            ...
                            <div class="row pb-2">
                                <div class="col-lg-4">
                                    <div class="form-group form-box">
                                        <label for="conveyanceAffidevit">Conveyance Deed (Along With Registration Details)</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="conveyanceAffidevitDate">Date of Document</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="conveyanceAffidevitAttestedby">Attested by</label>
                    ...
                    <div class="row row-mb-2">
                        ...
                        <div class="col-lg-11 selected-docs-field">
                            ...
                            <div class="row pb-2">
                                <div class="col-lg-4">
                                    <div class="form-group form-box">
                                        <label for="conveyanceRegDeed">Ownership Document</label>
                    ...
                    <div class="row row-mb-2">
                        ...
                        <div class="col-lg-11 selected-docs-field">
                            ...
                            <div class="row pb-2">
                                <div class="col-lg-4">
                                    <div class="form-group form-box">
                                        <label for="conveyanceApplicantAadhaar">Upload Aadhaar of Registered Applicant</label>
                    ...
                    <div class="row row-mb-2">
                        ...
                        <div class="col-lg-11 selected-docs-field">
                            ...
                            <div class="row pb-2">
                                <div class="col-lg-4">
                                    <div class="form-group form-box">
                                        <label for="conveyanceApplicantPan">Upload PAN of Registered Applicant</label>
    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            ...
            <ul class="consent-agree">
                ...
                <li>Payment of Non-Refundable Processing Fee {{ getApplicationCharge(getServiceType('SUB_MUT')) }} /-
                    Rs. (INR)</li>
            </ul>
