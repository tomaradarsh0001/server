		...
		<div class="col-12 col-lg-4">
		<label for="dateexecution" class="form-label">Date of Execution <small class="text-red">*</small></label>
		...
		<div class="col-12 col-lg-6">
		    <label for="propertySubType" class="form-label">Sub-Type (Purpose , at present) <small class="text-red">*</small></label>
		...
		value="{{ $propertyInspectionDemandDetail && is_null($propertyInspectionDemandDetail->splited_property_detail_id) ? $propertyInspectionDemandDetail->last_inspection_ir_date : '' }}">
		...
		id="LastDemandLetter"
		value="{{ $propertyInspectionDemandDetail && is_null($propertyInspectionDemandDetail->splited_property_detail_id) ? $propertyInspectionDemandDetail->last_demand_letter_date : '' }}">
		...
		value="{{ $propertyInspectionDemandDetail && is_null($propertyInspectionDemandDetail->splited_property_detail_id) ? $propertyInspectionDemandDetail->last_demand_id : '' }}">
		...
		value="{{ $propertyInspectionDemandDetail && is_null($propertyInspectionDemandDetail->splited_property_detail_id) ? $propertyInspectionDemandDetail->last_demand_amount : '' }}">
		...
		value="{{ $propertyInspectionDemandDetail && is_null($propertyInspectionDemandDetail->splited_property_detail_id) ? $propertyInspectionDemandDetail->last_amount_received : '' }}">
		...
		id="lastamountdate"
		value="{{ $propertyInspectionDemandDetail && is_null($propertyInspectionDemandDetail->splited_property_detail_id) ? $propertyInspectionDemandDetail->last_amount_received_date : '' }}">
...
<div class="col-lg-3 d-flex align-items-end">
                                <div class="form-check d-flex gap-2">
                                   <input class="form-check-input"   type="checkbox"  name="alert_flag"  value="1"    id="flexCheckCheckedDanger"
       {{ $propertyDetail->alert_flag == 1 ? 'checked' : '' }}>

                                    <label class="form-check-label" for="flexCheckCheckedDanger">
                                        Is Problemetic {{$propertyDetail->alert_flag}}
                                    </label>
                                </div>
                            </div>
		<div class="col-12">
...
<style>.text-red{color:red;}.btn i {
    ...
    margin-right: 5px;
		...
		<div class="row mb-3">
		<div class="col-12 col-lg-4 my-4">
		<label for="ProcessTransfer${index}" class="form-label">Process of transfer <small class="text-red">*</small></label>
		...
		<div class="col-12 col-lg-4 my-4">
		<label for="transferredDate${index}" class="form-label">Date <small class="text-red">*</small></label>
		...
		<div class="item-content row">
		<div class="col-lg-4 mb-3">
		<label for="name${index}" class="form-label">Name <small class="text-red">*</small></label>
		...
		<div class="col-lg-4 mb-3">
		<label for="share${index}" class="form-label">Share <small class="text-red">*</small></label>
		...
		<input type="text" class="form-control text-transform-uppercase pan_number_format" id="pannumber${index}" maxlength="10" name="panNumberNew${index}[]" placeholder="PAN Number" data-name="pannumber">
		<div id="pannumberError${index}" class="text-danger"></div>
		</div>
		<div class="col-lg-4 mb-3">
		<label for="aadharnumber${index}" class="form-label">Aadhar Number</label>
		<input type="text" class="form-control text-transform-uppercase" id="aadharnumber${index}" name="aadharNumberNew${index}[]" placeholder="Aadhar Number" data-name="aadharnumber" maxlength="16">
