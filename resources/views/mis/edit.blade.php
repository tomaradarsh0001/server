                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="is_multiple_prop_id" type="checkbox"
                                                {{ $propertyDetail->is_multiple_ids == 1 ? 'checked' : '' }}
                                ...
                                @if (isset($propertyMiscDetail->is_supplimentry_lease_deed_executed) &&
                                    ...
                                    <div class="col-lg-12">
                                        <div class="Supplementary-container row" id="SupplementaryContainer"
                                            {{ $propertyMiscDetail->is_supplimentry_lease_deed_executed == 1 ? '' : 'style="display: none;"' }}>
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <label for="SupplementaryDate" class="form-label">Date</label>
                                                    <input type="date" min="1600-01-01" max="2050-12-31"
                                                        class="form-control" name="supplementary_date"
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    ...
                                                    <div class="unit-field">
                                                        ...
                                                        <select class="form-select unit-dropdown" id=""
                                                            aria-label="Select Unit" name="supplementary_area_unit">
                                                ...
                                                <div class="col-12 col-lg-6 mt-3">
                                                    <label for="premiumunit1" class="form-label">Premium (Re/
                                                        Rs)</label>
                                                    <div class="unit-field">
                                                        <input type="text" class="form-control mr-2 numericOnly"
                                                            id="" name="supplementary_premium1"
                                                            value="{{ $propertyMiscDetail->supplementary_premium }}">
                                                        <input type="text" class="form-control numericOnly"
                                ...
                                @else
                                    ...
                                    <div class="col-12 col-lg-12">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="Supplementary"
                                                    value="0" id="SupplementaryFormNo" checked>
                                                <label class="form-check-label" for="SupplementaryFormNo">
                                                    <h6 class="mb-0">No</h6>
                                                </label>
                                            </div>
                        ...
                        <div id="test-vl-7" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="input" name="additional_remark"
                                        value="{{ $propertyDetail->additional_remark }}" placeholder="remark"
