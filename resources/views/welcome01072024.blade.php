...
<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat($totalCount)}}</h4>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat(round($totalArea))}}</h4>
						<p class="mb-0 text-secondary">Total Area in Sqm</p>
					</div>
				</div>
			</div>
		</div>
	</div>
	<div class="col" title="₹{{customNumFormat($totalLdoValue)}}">
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">₹{{customNumFormat(round($totalLdoValue/10000000))}} Cr.</h4>
	...
	<div class="col"  title="₹{{customNumFormat($totalCircleValue)}}">
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 text-dark grid-icons-size">₹{{customNumFormat(round($totalCircleValue/10000000))}} Cr.</h4>
...
<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat($statusCount['lease_hold'])}}</h4>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat(round($statusArea['lease_hold']))}}</h4>
						<p class="mb-0 text-secondary">Total Area of LH Properties</p>
					</div>
				</div>
			</div>
		</div>
	</div>
	<div class="col" title="₹{{customNumFormat($statusLdoValue['lease_hold'])}}">
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #F3E5F5;"><img src="{{asset('assets/images/sell.svg')}}" alt="Land Value">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">₹{{customNumFormat(round($statusLdoValue['lease_hold']/10000000))}} Cr.</h4>
	...
	<div class="col"  title="₹{{customNumFormat($statusCircleValue['lease_hold'])}}">
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #E0F2F1;"><img src="{{asset('assets/images/payments.svg')}}" alt="properties">
					...
					<div>
						<h4 class="my-1 text-dark grid-icons-size">₹{{customNumFormat(round($statusCircleValue['lease_hold']/10000000))}} Cr.</h4>
...
<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat($statusCount['free_hold'])}}</h4>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat(round($statusArea['free_hold']))}}</h4>
						<p class="mb-0 text-secondary">Total Area of FH Properties</p>
					</div>
				</div>
			</div>
		</div>
	</div>
	<div class="col" title="₹{{customNumFormat($statusLdoValue['free_hold'])}}">
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #F3E5F5;"><img src="{{asset('assets/images/sell.svg')}}" alt="Land Value">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">₹{{customNumFormat(round($statusLdoValue['free_hold']/10000000))}} Cr.</h4>
	...
	<div class="col"  title="₹{{customNumFormat($statusCircleValue['free_hold'])}}">
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #E0F2F1;"><img src="{{asset('assets/images/payments.svg')}}" alt="properties">
					...
					<div>
						<h4 class="my-1 text-dark grid-icons-size">₹{{customNumFormat(round($statusCircleValue['free_hold']/10000000))}} Cr.</h4>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($statusCount['free_hold'])}}</h4>
						<p class="mb-0 text-secondary">Total No of Free Hold Properties</p>
			...
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						...
						<p>({{customNumFormat(round($statusArea['free_hold']))}} sqm)</p>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($propertyTypeCount['Residential'])}}</h4>
						<p class="mb-0 text-secondary">Residential</p>
						{{-- <p>({{customNumFormat(round($propertyTypeArea['Residential']))}} sqm)</p> --}}
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($propertyTypeCount['Commercial'])}}</h4>
						<p class="mb-0 text-secondary">Commercial</p>
						{{-- <p>({{customNumFormat(round($propertyTypeArea['Commercial']))}} sqm)</p> --}}
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($propertyTypeCount['Industrial'])}}</h4>
						<p class="mb-0 text-secondary">Industrial</p>
						{{-- <p>({{customNumFormat(round($propertyTypeArea['Industrial']))}} sqm)</p> --}}
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($propertyTypeCount['Institutional'])}}</h4>
						<p class="mb-0 text-secondary">Institutional</p>
						{{-- <p>({{customNumFormat(round($propertyTypeArea['Institutional']))}} sqm)</p> --}}
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($propertyTypeCount['Mixed'])}}</h4>
						<p class="mb-0 text-secondary">Mixed</p>
						{{-- <p>({{customNumFormat(round($propertyTypeArea['Mixed']))}} sqm)</p> --}}
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="text-center">
					...
					<div>
						<h4 class="my-1 text-dark">{{customNumFormat($propertyTypeCount['Others'])}}</h4>
						<p class="mb-0 text-secondary">Others</p>
						{{-- <p>({{customNumFormat(round($propertyTypeArea['Others']))}} sqm)</p> --}}
					</div>
				</div>
			</div>
		</div>
