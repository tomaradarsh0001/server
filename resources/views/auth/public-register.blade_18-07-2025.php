                                    ...
                                    <div id="ifYesNotChecked" class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-12 isPropertyDetailsRecordNotFoundUnChecked"
                                                style="display: none;">
                                                <div class="form-group form-box">
                                                    <label for="flat_no_rec_not_found" class="quesLabel">Flat
                            ...
                            <div class="contentDiv" id="organizationDiv">
                                ...
                                <div id="OrgfileUploadSection" style="display: none;">
                                    <div class="row less-padding-input">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group form-box">
                                                <label for="scannedIDOrg" class="quesLabel">Scanned Copy of Aadhaar<span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-12">
                                                    <div class="form-group form-box">
                                                        <label for="saleDeedOrg" class="quesLabel">Sale Deed/Agreement
                                                            to Sale/Power of Atorney</label>
...
@section('footerScript')
    ...
    <script>
        ...
        document.getElementById('IndLeaseDeed').addEventListener('change', function() {
            // validateFileSize('IndLeaseDeed', 'IndLeaseDeedError', 20);
