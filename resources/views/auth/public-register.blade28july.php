                ...
                <div class="col-lg-12 mx-auto form-section" id="formColumnIncrease">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group form-box">
                                            <label for="IndPanNumber" class="quesLabel">PAN Number<span
                                                    class="text-danger">*</span></label>
                                            <input type="password" id="IndPanNumber"
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group form-box">
                                            <label for="IndAadhar" class="quesLabel">Aadhaar Number<span
                                                    class="text-danger">*</span></label>
                                            <input type="password" id="IndAadhar"
                                ...
                                <div class="row less-padding-input" id="addressDetails">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mix-field" style="margin-bottom: 10px;">
                                            <label for="propertyId_property" class="quesLabel">Is Your Property / Apartment in a multistorey building?</label>
                                            <div class="radio-options ml-5">
				   ...
				   <div class="row less-padding-input">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-12">
                                                    <div class="form-group form-box">
                                                        <label for="IndOwnerLess" class="quesLabel">Scanned Copy of ID
                                                            Proof/Document Showing Relationship with Owner/Lessee<span
                                                                class="text-danger">*</span></label>
                                                ...
                                                <div class="col-lg-12">
                                                    <h5 class="text-start mb-0 mt-2">Choose Any One</h5>
                                                    <div id="IndChooseOneError" class="text-danger text-left"></div>
                                                </div>
                                                <div class="col-md-6 col-lg-6 col-12">
                                                    <div class="form-group form-box">
                                                        <label for="propDoc" class="quesLabel d-flex align-items-center">
                                                        ...
                                                        <input type="file" name="saleDeedDocInv" class="form-control"
                                                            accept="application/pdf" id="IndSaleDeed" disabled>
                                                        <div id="IndSaleDeedError" class="text-danger text-left"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6 col-12">
                                                    <div class="form-group form-box">
                                                        ...
                                                        <input type="file" name="BuilAgreeDocInv" class="form-control"
                                                            accept="application/pdf" id="IndBuildAgree" disabled>
                                                        <div id="IndBuildAgreeError" class="text-danger text-left"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-12">
                                                    <div class="form-group form-box">
                                                        ...
                                                        <input type="file" name="subMutLtrDocInv" class="form-control"
                                                            accept="application/pdf" id="IndSubMut" disabled>
                                                        <div id="IndSubMutError" class="text-danger text-left"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6 col-12">
                                                    <div class="form-group form-box">
                                                        <label for="otherDocInv" class="quesLabel d-flex align-items-center">
                                                            <input type="checkbox" class="form-check" id="diffDoc">
                                                            <label class="quesLabel" for="diffDoc">Other Documents</label>                                                            
                                                        </label>
                                                        <input type="file" name="otherDocInv" class="form-control"
                                                            accept="application/pdf" id="IndOther" disabled>
                                                        <div id="IndOtherError" class="text-danger text-left"></div>
                                                    </div>
                                                </div>
                                            </div>
                               ...
                               /* <div class="checkbox form-group d-flex flex-column gap-3">
                                    <div>
                                        <input type="text" autocomplete="off" name="invRegisterCaptcha"
                                            id="invRegisterCaptcha" class="form-control"
                            ...
                            <div class="contentDiv" id="organizationDiv">
                                ...
                                <div class="row" id="OrgBasicDetails">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group form-box">
                                            <label for="orgAddressOrg" class="quesLabel">Organisation Address<span class="text-danger">*</span> <span class="additionalLabel"> (Allowed Characters [(-), (,), (#), ( ), (/)] are allowed)</span></label>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group form-box">
                                            <label for="orgAadharAuth" class="quesLabel">Aadhaar No. of Authorised
                                                Signatory<span class="text-danger">*</span></label>
                                            <input type="password" class="form-control numericOnly"
                                                placeholder="Aadhaar No." id="orgAadharAuth" maxlength="12">
                                            <input type="hidden" name="orgAddharNo" id="encryptedInput">
					    ...
					    <div class="row">
                                                ...
                                                <div class="col-lg-4 col-12 isPropertyDetailsNotFoundUnCheckedOrg"
                                                    ...
                                                    <div class="form-group form-box">
                                                        ...
                                                        <input type="text"
                                                            class="form-control alphaNumHypSlashParenthspace"
                                                            name="flat_no_org" id="flat_no_org" placeholder="Flat Number"
                                                ...
                                                <div class="col-lg-4 col-12 isPropertyDetailsRecordNotFoundUnCheckedOrg"
                                                    style="display: none;">
                                                    <div class="form-group form-box">
                                                        <label for="flat_no_org_rec_not_found" class="quesLabel">Flat Number
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text"
                                                            class="form-control alphaNumHypSlashParenthspace"
                                                            name="flat_no_org_rec_not_found" id="flat_no_org_rec_not_found"
					...
					<div class="col-lg-12">
                                            <h5 class="form_section_title mb-0 mt-2">Choose Any One</h5>
			       ...
			       <div class="row --bs-gutter-x-0">
                                    <div class="col-sm-6">
                                        <div class="checkbox form-group d-flex align-items-start gap-3">
                                            <div style="width:300px">
                                                <input type="text" autocomplete="off" name="orgRegisterCaptcha" id="orgRegisterCaptcha"
                                                class="form-control" placeholder="Enter captcha from below image">
                                                <div id="orgRegisterCaptchaError" class="text-danger text-left"></div>
                                            </div>
                                            <div class="d-flex align-items-center gap-1">
                                                <img src="{{ captcha_src() }}" alt="captcha" id="orgCaptchaImage" class="captcha-image">
                                                <span class="btn btn-primary btn-sm refresh-captcha" id="orgRefreshCaptcha"
                                                    style="padding: 10px 13px;">
                                                    <i class="fas fa-sync-alt"></i>
                                                </span>
...
@section('footerScript')
    ...
    <script>
        $('#IndAadhar, #orgAadharAuth, #OrgPAN, #IndPanNumber').blur(function() {
 ...
 <script>
  ...
  $('#refreshCaptcha').on('click', function() {
        ...
        $('#orgRefreshCaptcha').on('click', function() {
            $.ajax({
                url: "{{ route('refresh.captcha') }}",
                type: "GET",
                success: function(data) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                if (response.showUploadDocumentField) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                Indmobile.setAttribute('data-id', '1');
                                if (response.showUploadDocumentField) {
                                    $('#OrgfileUploadSection').show();
                                } else {
                                    $('#OrgfileUploadSection').hide();
                                }
                            } else {
                                mobileVerifySuccessDiv.html('')
                                mobileVerifyErrorDiv.html(response.message)
