                        ...
                        <form action="{{ route('publicRegisterCreate') }}" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="radio-btn">
                                                <div class="content">
                                                    <div class="profile-card">
                                                        <h4>Services in existing property (Existing Lessee)</h4>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <label for="coming_soon" class="custom-radio">
                                            <div class="radio-btn">
                                                <div class="content">
                                                    <div class="profile-card">
                                                        <h4>Allotment of New Property (New Lessee)</h4>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="contentDiv" id="propertyownerDiv">
                                ...
                                <div class="row less-padding-input" id="basicDetails">
                                    ...
                                    <div class="col-lg-6 col-12" id="isPanDiv">
                                        <div class="form-group form-box">
                                    ...
                                    <div class="col-lg-6 col-12" id="isAadharDiv">
                                        <div class="form-group form-box">
                                    ...
                                    <div class="col-lg-6 col-12" id="isPassportDiv" style="display: none;">
                                        <div class="form-group form-box">
                                            <label for="documentType" class="quesLabel">Document Type<span
                                                    class="text-danger">*</span></label>
                            ...
                            <div class="contentDiv" id="organizationDiv">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12" id="isAadharDivOrg">
                                        <div class="form-group form-box">
                                    ...
                                    <div class="col-lg-6 col-12" id="isPassportDivOrg" style="display: none;">
                                        <div class="form-group form-box">
                                            <label for="documentTypeOrg" class="quesLabel">Document Type<span
                                                    class="text-danger">*</span></label>
...
@section('footerScript')
    ...
    <script>
        ...
        $(document).ready(function() {
            const label = document.getElementById('scannedIDOrgLabel');
            const documentTypeDropDown = document.getElementById('documentTypeOrg');
            // $('#isIndian').change(function() {
            //     if ($(this).is(':checked')) {
            //         // When checked - show NRI/OCI divs, hide PAN/Aadhar divs
            //         $('#isPanDiv').show();
            //         $('#isAadharDiv').show();
            //         $('#isOciCardDiv').hide();
            //         $('#isPassportDiv').hide();
            ...
            //     } else {
            //         // When unchecked - show PAN/Aadhar divs, hide NRI/OCI divs
            //         $('#isPassportDiv').show();
            //         $('#isOciCardDiv').show();
            //         $('#isPanDiv').hide();
            //         $('#isAadharDiv').hide();
            ...
            // Initialize on page load based on selected radio
            if ($("input[name='isIndian']:checked").val() === "1") {
                $('#isPanDiv').show();
                $('#isAadharDiv').show();
                $('#isOciCardDiv').hide();
                $('#isPassportDiv').hide();
            ...
            // $('#isIndianOrg').change(function() {
            //     if ($(this).is(':checked')) {
            //         // When checked - show NRI/OCI divs, hide PAN/Aadhar divs
            //         $('#isAadharDivOrg').show();
            //         $('#isOciCardDivOrg').hide();
            //         $('#isPassportDivOrg').hide();
            //         label.innerHTML = 'Scanned Copy of Aadhaar <span class="text-danger">*</span>';
            //     } else {
            //         // When unchecked - show PAN/Aadhar divs, hide NRI/OCI divs
            //         $('#isPassportDivOrg').show();
            //         $('#isOciCardDivOrg').show();
            //         $('#isAadharDivOrg').hide();
            //         // When document type dropdown changes
            ...
            //                 .selectedIndex].text;
            //             // const selectedValue = documentTypeDropDown.value;
            ...
            //     // When document type dropdown changes
            //     documentTypeDropDown.addEventListener('change', function() {
            //         const selectedText = documentTypeDropDown.options[documentTypeDropDown.selectedIndex]
            //             .text;
            //         // const selectedValue = documentTypeDropDown.value;
            //         // console.log('Selected Text:', selectedText);
            //         // console.log('Selected Value:', selectedValue);
            ...
            (function initOrgSection() {
                const label = document.getElementById('orgLabel');
                const documentTypeDropDown = document.getElementById('documentTypeOrg');
                const isIndianOrgVal = $("input[name='isIndianOrg']:checked").val();
