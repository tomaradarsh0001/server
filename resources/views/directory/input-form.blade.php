                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="is_active" name="is_active" {{ isset($mode) && $mode == 'view' ? 'disabled' : '' }}>
                                            <option value="1" {{ (isset($directories) && $directories->is_active == 1) || !isset($directories) ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ (isset($directories) && $directories->is_active == 0) ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
