                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-12">
                                                        <div class="form-group form-box">
                                                            ...
                                                            <label for="{{ $document['id'] }}" class="quesLabel form-label">{{$document['label']}}<span
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <!-- added class form-label by anil on 17-04-2025 -->
                                                            <label for="dateattestation" class="form-label">{{$input['label']}}<span
                                                                    class="text-danger">*</span></label>
                                                            @if($input['type'] == 'select')
                                                            <select name="{{$input['id']}}" id="{{$input['id']}}" class="form-select">
                                                                <option value="">Select</option>
                                                                @foreach($input['options'] as $option)
                                                                <option value="{{$option}}" {{(isset($uploadedValue) && $uploadedValue->value == $option) ? 'selected': ''}}>{{$option}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="repeater-remove-btn" style="margin-bottom: 0px;">
                                                            <button type="button" class="btn-invisible remove-btn px-4"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="Click here to delete this document." onclick="removeRepeater($(this).parents('.items'),'{{$ud->index_no ?? $loop->iteration}}')">
                                                                <i class="fadeIn animated bx bx-x-circle"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="repeater-remove-btn" style="margin-bottom: 0px;">
                                                            <button type="button" class="btn-invisible remove-btn px-4"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                                title="Click here to delete this document." onclick="removeRepeater($(this).parents('.items'),1)">
                                                                <i class="fadeIn animated bx bx-x-circle"></i>
                                                            </button>
                                                        </div>
                                                        @endif
