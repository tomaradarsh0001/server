                ...
                <div class="row row-mb-2">
                    ...
                    <div class="col-lg-11 selected-docs-field">
                        ...
                        <div class="row pb-2">
                            ...
                            <div class="col-lg-12 mt-2" id="optionalInputs" style="display: {{ $isLeaseDeedLost ? 'block':'none' }};">
                                <div class="row">
                                    @endif
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group form-box">
                                            ...
                                            <label for="{{$document['id']}}" class="form-label">{{$document['label']}} 
                                                @if ($document['id'] == 'documentpowerofattorney' || $document['id'] == 'convOptLeaseLostAffidevit' || $document['id'] == 'convLeaseLostAffidevitDocumentDate' || $document['id'] == 'convLeaseLostAffidevitAttestedBy' || $document['id'] == 'convOptLeaseLostPublicNotice' || $document['id'] == 'convOptLeaseLostPublicNoticeNameOfNewspaper')
                                            ...
                                            <input type="file" name="{{$document['id']}}" class="form-control"
                                                ...
                                                data-should-validate = "{{ isset($uploadedDocument) && $uploadedDocument->file_path != '' }}">
                                                @if ($uploadedDocument)
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <!-- added class form-label by anil on 17-04-2025 -->
                                            <label for="{{$docInput['id']}}" class="form-label">{{$docInput['label']}}
                                            @if ($document['id'] == 'documentpowerofattorney' || $document['id'] == 'convOptLeaseLostAffidevit' || $document['id'] == 'convLeaseLostAffidevitDocumentDate' || $document['id'] == 'convLeaseLostAffidevitAttestedBy' || $document['id'] == 'convOptLeaseLostPublicNotice' || $document['id'] == 'convOptLeaseLostPublicNoticeNameOfNewspaper')
                                                    <span class="text-danger">*</span>
                                                @endif
                                            ...
                                            <input type="{{$docInput['type']}}" name="{{$docInput['id']}}"
                                                ...
                                                <div id="{{$docInput['id']}}Error" class="text-danger text-left"></div>
                                        </div>
                                    </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-12">
                ...
                <ul class="consent-agree">
                    <li>Processing fee of Rs.{{ getApplicationCharge(getServiceType('CONVERSION')) }} /- is non-refundable.</li>
                </ul>
