                ...
                <table class="table report-item">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Application Current Status: <span class="highlight_value"> <!-- spelling correction by anil on 04-03-2025 -->
                        ...
                        <table class="table table-bordered property-table-info">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ !empty($details->purchased_date) ? \Carbon\Carbon::parse($details->purchased_date)->format('d-m-Y') : '' }}</td>
    ...
    function handleApplicationAction(action, applicationNo, button, remark = null) {
        ...
        if (!needToconfirm) {
            ...
            if (allChecked) {
                ...
                $('#actionConfirmationButton').click(function() {
