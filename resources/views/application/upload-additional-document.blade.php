                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-box">
                                    ...
                                    <input type="text" name="additional_document_titles[]" class="form-control"
                                        ...
                                        <div id="additionaldocumenttitlesError" class="text-danger text-left"></div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div id="additionaldocumentsError" class="text-danger text-left"></div>
                                </div>
                            </div>
                            <div class="col-lg-4">
...
<div class="col-lg-12">
    <div class="form-group">
        <label for="regno" class="form-label">Remark <span class="text-danger">*</span></label>
        <textarea rows="4" class="form-control" name="additionalRemark" id="remarks" placeholder="Remarks" data-listener-added_5916a0ef="true" spellcheck="false"></textarea>
        <div id="additionalRemark" class="text-danger text-left"></div>
</div>
