        ...
        <div id="conveyanceRepeater" class="position-relative coapplicant-block">
            ...
            <div class="position-sticky text-end mt-2"
                ...
                <button type="button" class="btn btn-primary repeater-add-btn fullwidthbtn" data-toggle="tooltip"
                    data-placement="bottom" title="Click here to add more co-applicant.">
                    ...
                    <div class="items coapplicant-block" data-group="noccoapplicant" data-type='coapplicant'>
                            ...
                            <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="age-box">
                                                    ...
                                                    <input type="text" id="age" name="age" value=""
                                                        data-name="age" class="form-control" placeholder="0"
                                                        readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row merge-inputs">
                                            <div class="col-lg-6">
                                                <select name="conPrefixInv" data-name="conPrefixInv" id="prefix"
                                                    ...
                                                    <option value="S/o"
                                                        {{ $coapplicant->prefix == 'S/o' ? 'selected' : '' }}>S/o
                                                    </option>
                                                    <option value="D/o"
                                                        {{ $coapplicant->prefix == 'D/o' ? 'selected' : '' }}>D/o
                                                    </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar" class="form-control numericOnly"
                                            ...
                                            data-name="aadharnumber" value="{{ decryptString($coapplicant->co_applicant_aadhar) }}">
                                        <span class="error-message text-danger"></span>
                                    </div>
                                </div>
                                <!-- ------------------------ -->
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <!-- add class "text-uppercase" for pan number input to show text uppercase on 13-05-2025-->
                        ...
                        <div class="repeater-remove-btn">
                            <button type="button" class="btn btn-danger remove-btn px-4" data-toggle="tooltip"
                                data-placement="bottom" title="Click here to delete this co-applicant." editmode="true"
