        ...
        <div class="row g-3 mb-2 mt-3">
            ...
            <div class="col-lg-4 col-12">
                <div class="form-group form-box">
                    ...
                    <input type="text" name="lucarea" id="lucarea" class="form-control alpha-only"
        ...
        <div class="row g-3 mb-2 mt-3">
            ...
            <div class="col-lg-3 col-12">
                <div class="form-group">
                    ...
                    <select name="lucpropertytypeto" id="lucpropertytypeto" class="form-select" disabled>
            ...
            <div class="col-lg-3 col-12">
                <div class="form-group">
                    <label for="lucpropertysubtypeto" class="form-label">Change to Property Sub Type<span
                            class="text-danger">*</span> </label>
                    <select name="lucpropertysubtypeto" id="lucpropertysubtypeto" class="form-select"disabled>
