		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat(round($totalArea,2))}}</h4>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat(round($statusArea['lease_hold'],2))}}</h4>
		...
		<div class="card radius-10 border-start border-0">
			<div class="card-body">
				<div class="d-flex align-items-center">
					...
					<div>
						<h4 class="my-1 grid-icons-size text-dark">{{customNumFormat(round($statusArea['free_hold'],2))}}</h4>
