                        ...
                        @foreach ($user->userProperties as $property)
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <h5 class="text-primary">PROPERTY ID :
                                        {{ $property->old_property_id ?? $property->new_property_id }}</h5>
                                    ...
                                    <table class="table table-bordered property-table-info">
                                        <tbody>
                                            <tr>
                                                <th>Property ID :</th>
                                                <td>{{ $property->old_property_id ?? $property->new_property_id }}</td>
                                                    ...
                                                    @if ($property->documents->isNotEmpty())
                                                        <span class="view-hover-data show-toggle-data ms-2"
                                                            ...
                                                            <a href="javascript:void(0);" style="color: red;"
                                                                class="pdf-icons"><i class='bx bxs-file-pdf fs-4'></i></a>
                                                            <!-- edit inline css for tooltip data ui issue by anil on 1-9-2025 -->
                                                            <div class="tooltip-data"
                                                                style="left: 15px; min-width:250px;width:fit-content;max-width:350px;padding-bottom:25px;">
                    ...
                    @if ($newProperties)
                        @foreach ($newProperties as $newProperty)
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <h5 class="text-primary">PROPERTY ID :
                                        {{ $newProperty->old_property_id ?? ($newProperty->suggested_property_id ?? 'The process for generating the property ID is currently underway.') }}
                                    </h5>
                                    <table class="table table-bordered property-table-info">
                                        <tbody>
                                            <tr>
                                                <th>Property ID :</th>
                                                <td>{{ $newProperty->old_property_id ?? ($newProperty->suggested_property_id ?? 'Under Process.') }}
                                                </td>
                                                <th>Current Status:</th>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <th>Block :</th>
                                                <td>
                                                    {{ $newProperty->block && $newProperty->block !== 'Default' ? $newProperty->block : '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Plot :</th>
                                    ...
                                    <div class="row g-3">
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="isPropertyFlat">Are you applying for
                                                    flat or floor?</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted">Upload all documents in PDF format (maximum size
                                                    20 MB each).</small>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="IndLeaseDeed" class="form-label">Lease Deed/Conveyance
                                                    Deed</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label class="note text-dark"><strong>Note:</strong> Upload all documents
                                                    in PDF format (maximum size 20 MB each).</label>
