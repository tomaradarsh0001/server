...
import SwwImage from "../../public/something-went-wrong.png";
            ...
            <div className="text-center">
                ...
                <div className="relative">
                    <Image
                        ...
                        height={100}
                    />
                    <h1 className="text-[40px] font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 leading-none pb-5" style={{ backgroundImage: 'linear-gradient(to right, rgb(51 130 234), #0f3557)' }} >
                        500
                    </h1>
                ...
                <p className="mt-4 text-lg text-gray-600 max-w-lg mx-auto">
                    Oops! Something went wrong while processing your request. Please try refreshing the page or come back later.
                </p>
