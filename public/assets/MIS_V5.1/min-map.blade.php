    ...
    <header id="header">
        <div class="custom-inner-header">
            <div class="header-logo">
                <img style="height:auto;" src="https://dfwgnctd.maps.arcgis.com/sharing/rest/content/items/7292401d0ef943b584440df376f0b3ee/resources/media/instantAppsConfigPanel_1717672004862_customHeaderHTML_textEditor_1717672004472.png" class="e-dharti-logo">
            </div>
            ...
            <div class="brand_label">
                ...
                <a href="https://dfwgnctd.maps.arcgis.com/apps/instant/3dviewer/index.html?appid=7292401d0ef943b584440df376f0b3ee" target="_blank" class="metaverse-link">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div id="spinner" style="display: none;">
            <img src="{{asset('assets/MIS_V5.1/Logo/Red.png')}}" alt="Loading..."  />
        </div>
        <!-- 
...
<script src="{{asset('assets/MIS_V5.1/Geojson_s/Property_19376.js')}}"></script>
