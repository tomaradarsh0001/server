...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function validateConvRegOn() {
    ...
    if (convRegNoValue === "") {
      convRegNoError.text("Registration No is required");
  ...
  function validateConvBookno() {
    ...
    if (convBooknoValue === "") {
      convBooknoError.textContent = "Book No. is required";
      convBooknoError.style.display = "block";
      return false;
    }

    // Check if the Book No. is numeric
    if (isNaN(convBooknoValue)) {
      convBooknoError.textContent = "Book No. must be a numeric value";
      convBooknoError.style.display = "block";
      return false;
    }
    ...
    if (parseFloat(convBooknoValue) <= 0) {
      convBooknoError.textContent = "Book No. must be a positive number";
      convBooknoError.style.display = "block";
      return false;
    }
  ...
  function validateConvVolumeno() {
    ...
    if (convVolumenoValue === "") {
      convVolumenoError.textContent = "Volume is required";
      convVolumenoError.style.display = "block";
      return false;
    }

    // Check if the value is numeric
    if (isNaN(convVolumenoValue)) {
  ...
  function validateConvPagenoFrom() {
    ...
    if (convPagenoFromValue === "") {
      convPagenoFromError.textContent = "Page No From is required";
      convPagenoFromError.style.display = "block";
      return false;
    }

    // Check if the value is numeric
    if (isNaN(convPagenoFromValue)) {
      convPagenoFromError.textContent = "Page No From must be a numeric value";
      convPagenoFromError.style.display = "block";
      return false;
    }
  ...
  function validateConvPagenoTo() {
    ...
    if (convPagenoToValue === "") {
      convPagenoToError.textContent = "Page No To is required";
    ...
    // Check if the value is numeric
    if (isNaN(convPagenoToValue)) {
      convPagenoToError.textContent = "Page No To must be a numeric value";
      convPagenoToError.style.display = "block";
      return false;
    }
    ...
    if (parseFloat(convPagenoToValue) <= 0) {
      convPagenoToError.textContent = "Page No To must be a positive number";
      convPagenoToError.style.display = "block";
      return false;
    }
  ...
  function validateConvRegDate() {
    ...
    if (convRegDateValue === "") {
      convRegDateError.textContent = "Reg. Date is required";
    ...
    if (convRegDateValue > today) {
      convRegDateError.textContent = "Reg. Date cannot be in the future";
      convRegDateError.style.display = "block";
  ...
  function validateConvCourtOrderFields() {
    ...
    const CourtMaxFileSize = 5 * 1024 * 1024; // 5MB in bytes
    var today = new Date().toISOString().split("T")[0]; // Get today's date in YYYY-MM-DD format
    if (convYesCourtOrder.checked) {
      let isconvYesCourtOrderValid = true;

      if (convCaseNo.value.trim() === "") {
        convCaseNoError.textContent = "Case No. is required";
      ...
      if (convCourtOrderFile.getAttribute("data-should-validate") == 1) {
        ...
        isconvYesCourtOrderValid = false;
      } else if (convCourtOrderFile.files[0].size > CourtMaxFileSize) {
        convCourtOrderFileError.textContent =
      ...
      if (convCourtOrderDate.value.trim() === "") {
        ...
        convCourtOrderDateError.style.display = "block";
        convCourtOrderDate.value = ""; // Clear invalid input
        return false;
      } else {
    ...
    if (convYesMortgaged.checked) {
      ...
      if (convMortgageeNOC.getAttribute("data-should-validate") == 1) {
        ...
        convMortgageeNOCError.textContent =
          "Mortgagee NOC PDF File is required";
        convMortgageeNOCError.style.display = "block";
        isconvYesMortgagedValid = false;
      } else if (convMortgageeNOC.files[0].size > CourtMaxFileSize) {
        convMortgageeNOCError.textContent =
          "PDF File size must be less than 5MB";
        convMortgageeNOCError.style.display = "block";
        isconvYesMortgagedValid = false;
      ...
      if (convDateOfNOC.value.trim() === "") {
        ...
        convDateOfNOCError.style.display = "block";
        convDateOfNOC.value = ""; // Clear invalid input
        return false;
      } else {
  ...
  // function mandatoryMutDocumentsForm() {
    function validateMandatoryConvDocumentsForm() {
      ...
      $("#convDocIndemnityBond_repeater .items").each(function (index, element) {
        ...
        if (!convIndemnityBondFile) {
          ...
          if (convIndemnityBondFile.size > 5 * 1024 * 1024) {
            isConvIndemnityValid = false;
            $(element)
              .find(
                "#convdocindemnitybond_conversion_" +
        ...
        if (!convAttestedBy) {
          ...
          $(element)
            ...
            .siblings(".text-danger")
            .text("Attested By can only contain alphabetic characters");
        }
      ...
      $("#convDocUndertaking_repeater .items").each(function (index, element) {
        ...
        if (!convIndeBondFile) {
          ...
          // Validate file size (5MB limit)
          if (convIndeBondFile.size > 5 * 1024 * 1024) {
            isConvUndertakingValid = false;
            $(element)
              .find(
                "#convdocundertaking_conversion_" +
      ...
      $("#convDocPropertyPhoto_repeater .items").each(function (index, element) {
        ...
        if (!convPropertyBonaFide) {
          ...
          // Validate file size (5MB limit)
          if (convPropertyBonaFide.size > 5 * 1024 * 1024) {
            isConvPropertyBonaFideValid = false;
            $(element)
              .find(
                "#convdocpropertyphoto_conversion_" +
    ...
    function validateConvContructionProofType() {
      ...
      if (convContructionProofTypeValue === "") {
        convContructionProofTypeError.textContent =
          "Please Select Proof of Construction";
    ...
    function validateConvContructionProofIssuing() {
      ...
      if (convContructionProofIssuingValue === "") {
        convContructionProofIssuingError.textContent =
          "Construction Proof Issued By is required";
      ...
      if (!convContructionAlpha.test(convContructionProofIssuingValue)) {
        convContructionProofIssuingError.textContent =
          "Issued By must only contain alphabets";
        convContructionProofIssuingError.style.display = "block";
        return false;
      } else {
    ...
    function validateConvPossessionProofType() {
      ...
      if (validateConvPossessionProofTypeValue === "") {
        convPossessionProofTypeError.textContent =
          "Please Select Proof of Possession";
    ...
    function validateConvPossessionProofIssuing() {
      ...
      if (convPossessionProofIssuingValue === "") {
        convPossessionProofIssuingError.textContent =
          "possession Proof Issued By is required";
    ...
    function validateConvMandDocAdhaar() {
      if (convMandDocAdhaar.files.length > 0) {
        ...
        convMandDocAdhaarError.textContent = "Adhaar PDF file is required";
        return false;
      }
    }
    ...
    function validateConvMandDocPan() {
      if (convMandDocPan.files.length > 0) {
        ...
        convMandDocPanError.textContent = "Pan Card PDF file is required";
        return false;
      }
    }
    ...
    function validateConvMandDocAttestedby() {
      ...
      if (!convAttestedbyAlpha.test(convMandDocAttestedbyValue)) {
        convMandDocAttestedbyError.textContent =
          "Attested By must only contain alphabets";
        convMandDocAttestedbyError.style.display = "block";
        return false;
      } else {
    ...
    function validateConvLesseeAliveAffidevitFile() {
      if (convLesseeAliveAffidevitFile.files.length > 0) {
        var file = convLesseeAliveAffidevitFile.files[0];
        if (file.size > 5 * 1024 * 1024) {
        ...
        if (
          convLesseeAliveAffidevitFile.getAttribute("data-should-validate") == 1
        ) {
          return true;
        }
        convLesseeAliveAffidevitFileError.textContent =
    ...
    function validateConvLesseeAliveAffidevitDate() {
      var convLesseeAliveAffidevitDateValue =
        convLesseeAliveAffidevitDate.value.trim();
      var today = new Date().toISOString().split("T")[0]; // Get today's date in YYYY-MM-DD format
  
      if (convLesseeAliveAffidevitDateValue === "") {
      ...
      // Future date validation
      if (convLesseeAliveAffidevitDateValue > today) {
        convLesseeAliveAffidevitDateError.textContent =
          "Date of Document cannot be in the future";
        convLesseeAliveAffidevitDateError.style.display = "block";
        convLesseeAliveAffidevitDate.value = ""; // Clear invalid input
        return false;
      }
    ...
    function validateConvLesseeAliveAttestedby() {
      var convLesseeAliveAttestedbyValue = convLesseeAliveAttestedby.value.trim();
      if (convLesseeAliveAttestedbyValue === "") {
        convLesseeAliveAttestedbyError.textContent = "Attested By is required";
        convLesseeAliveAttestedbyError.style.display = "block";
        return false;
      }
      var convAliveDeedAlpha = /^[A-Za-z\s]+$/;
      if (!convAliveDeedAlpha.test(convLesseeAliveAttestedbyValue)) {
      ...
      if (convYesLeaseDeedLost.checked) {
        ...
        if (
          ...
          convLeaseLostAffidevitFileError.textContent =
            "Lease Deed Affidevit PDF File is required";
          convLeaseLostAffidevitFileError.style.display = "block";
          isconvYesLeaseDeedLostValid = false;
        } else if (convLeaseLostAffidevitFile.files[0].size > CourtMaxFileSize) {
          convLeaseLostAffidevitFileError.textContent =
            "PDF File size must be less than 5MB";
          convLeaseLostAffidevitFileError.style.display = "block";
          isconvYesLeaseDeedLostValid = false;
        ...
        if (
          ...
          convLeaseLostNoticeFileError.textContent =
            "Public Notice PDF File is required";
          convLeaseLostNoticeFileError.style.display = "block";
          isconvYesLeaseDeedLostValid = false;
        } else if (convLeaseLostNoticeFile.files[0].size > CourtMaxFileSize) {
          convLeaseLostNoticeFileError.textContent =
            "PDF File size must be less than 5MB";
          convLeaseLostNoticeFileError.style.display = "block";
          isconvYesLeaseDeedLostValid = false;
      ...
      if (isAnyFieldFilled) {
        ...
        if (!coPhotoFile) {
          ...
          if (!coPhotoValidExtensions.includes(coPhotoFileExtension)) {
            ...
            $(element)
              .find("#coapplicant_" + currentIndex + "_photo")
...
$(document).on(
  "blur change",
  "#CONrepeater .coapplicant-block input, #CONrepeater .coapplicant-block select",
  function () {
    ...
    if (isAnyConFieldFilled) {
      ...
      if (!conCoPhotoFile) {
        ...
        if (!conCoPhotoValidExtensions.includes(conCoPhotoFileExtension)) {
          ...
          // Clear the invalid file input
          $(element)
            .find("#convcoapplicant_" + currentIndex + "_photo")
            .val(""); // Reset file input
      ...
      // if (!conCoPhotoFile) {
      //   isCoapplicantConValid = false;
      //   showErrorMessage(element, "Please upload Co-Applicant Passport Size Photo", "#convcoapplicant_" + currentIndex + "_photo");
...
// added by anil kuamr on 20-03-2025 for NOC step 1 form validtaion
// $(document).on( "blur change", "#conveyanceRepeater .coapplicant-block input, #conveyanceRepeater .coapplicant-block select",
//   function () {
...
function coapplicantNocRepeaterForm() {
  ...
  $("#conveyanceRepeater .coapplicant-block").each(function (index, element) {
    ...
    if (isAnynocFieldFilled) {
      ...
      } else if (nocCoAdhaarFile && nocCoAdhaarFile.size > 5 * 1024 * 1024) {
        // 5MB limit for Aadhaar file
        isCoapplicantNocValid = false;
        showErrorMessage(
          element,
...
function validateNocApplicationType() {
  ...
  if (nocApplicantStatusValue === "") {
    nocApplicantStatusError.textContent = "Application Type is required";
...
function validateNocRegNo() {
  ...
  if (nocRegNoValue === "") {
    nocRegNoError.textContent = "Registration No is required";
...
function validateNocBookno() {
  ...
  // Check if the field is empty
  if (nocBooknoValue === "") {
    nocBooknoError.textContent = "Book No. is required";
    nocBooknoError.style.display = "block";
    return false;
  }

  // Check if the Book No. is numeric
  if (isNaN(nocBooknoValue)) {
    nocBooknoError.textContent = "Book No. must be a numeric value";
    nocBooknoError.style.display = "block";
    return false;
  }
  ...
  if (parseFloat(nocBooknoValue) <= 0) {
    nocBooknoError.textContent = "Book No. must be a positive number";
    nocBooknoError.style.display = "block";
    return false;
  }
...
function validateNocVolumeno() {
  ...
  // Check if the field is empty
  if (nocVolumenoValue === "") {
    nocVolumenoError.textContent = "Volume is required";
    nocVolumenoError.style.display = "block";
    return false;
  }

  // Check if the value is numeric
  if (isNaN(nocVolumenoValue)) {
    nocVolumenoError.textContent = "Volume must be a numeric value";
    nocVolumenoError.style.display = "block";
    return false;
  }
...
function validateNocPagenoFrom() {
  ...
  if (nocPagenoFromValue === "") {
    nocPagenoFromError.textContent = "Page No From is required";
    nocPagenoFromError.style.display = "block";
    return false;
  }

  // Check if the value is numeric
  if (isNaN(nocPagenoFromValue)) {
    nocPagenoFromError.textContent = "Page No From must be a numeric value";
    nocPagenoFromError.style.display = "block";
    return false;
  }
  ...
  if (parseFloat(nocPagenoFromValue) <= 0) {
    nocPagenoFromError.textContent = "Page No From must be a positive number";
    nocPagenoFromError.style.display = "block";
    return false;
  }
  // Check if 'Page No. From' is greater than 'Page No. To'
  if (parseInt(nocPagenoFromValue) > parseInt(nocPagenoValueTo)) {
    nocPagenoFromError.textContent = "From cannot be greater than Page No. To";
    nocPagenoFromError.style.display = "block";
    return false;
  } else {
...
function validateNocPagenoTo() {
  ...
  // Check if the field is empty
  if (nocPagenoToValue === "") {
    nocPagenoToError.textContent = "Page No To is required";
  ...
  // Check if the value is numeric
  if (isNaN(nocPagenoToValue)) {
    nocPagenoToError.textContent = "Page No To must be a numeric value";
    nocPagenoToError.style.display = "block";
    return false;
  }
  ...
  if (parseFloat(nocPagenoToValue) <= 0) {
    nocPagenoToError.textContent = "Page No To must be a positive number";
    nocPagenoToError.style.display = "block";
    return false;
  }
...
function validateNocRegDate() {
  ...
  if (nocRegDateValue === "") {
    nocRegDateError.textContent = "Reg. Date is required";
  ...
  if (nocRegDateValue > today) {
    nocRegDateError.textContent = "Reg. Date cannot be in the future";
    nocRegDateError.style.display = "block";
...
//   nocRegDate.addEventListener("blur", validateNocRegDate);
//   nocRegDate.addEventListener("change", validateNocRegDate);
// });
...
// var conveyanceDateOfAttestaion = document.getElementById(
//   "conveyancedeedDateOfAttestation"
// );
// var conveyanceDateOfAttestaionError = document.getElementById(
//   "conveyancedeedDateOfAttestationError"
// );

// var conveyancedeedAttestedBy = document.getElementById(
//   "conveyancedeedAttestedBy"
// );
// var conveyancedeedAttestedByError = document.getElementById(
//   "conveyancedeedAttestedByError"
// );

// var owndership_document = document.getElementById("owndership_document");
// var owndership_documentError = document.getElementById("owndership_documentError");
...
function validateForm2Noc() {
  ...
  // var isConveyanceDateOfAttestaion = validateConveyanceDateOfAttestaion();
  // var isConveyancedeedAttestedBy = validateConveyancedeedAttestedBy();
  ...
  return (
    ...
    // isConveyanceDateOfAttestaion &&
    // isConveyancedeedAttestedBy &&
...
/* function validateConveyanceDateOfAttestaion() {
  var conveyanceDateOfAttestaionValue = conveyanceDateOfAttestaion.value.trim();
  var today = new Date().toISOString().split("T")[0]; // Get today's date in YYYY-MM-DD format

  if (conveyanceDateOfAttestaionValue === "") {
    conveyanceDateOfAttestaionError.textContent =
      "Date of Attestation is required";
    conveyanceDateOfAttestaionError.style.display = "block";
    return false;
  }

  // Future date validation
  if (conveyanceDateOfAttestaionValue > today) {
    conveyanceDateOfAttestaionError.textContent =
      "Date of Attestation cannot be in the future";
    conveyanceDateOfAttestaionError.style.display = "block";
    conveyanceDateOfAttestaion.value = ""; // Clear invalid input
    return false;
  }

  conveyanceDateOfAttestaionError.style.display = "none";
  return true;
}

function validateConveyancedeedAttestedBy() {
  var conveyancedeedAttestedByValue = conveyancedeedAttestedBy.value.trim();
  if (conveyancedeedAttestedByValue === "") {
    conveyancedeedAttestedByError.textContent = "Attested By is required";
    conveyancedeedAttestedByError.style.display = "block";
    return false;
  }
  var convAttestedbyAlpha = /^[A-Za-z\s]+$/;
  if (!convAttestedbyAlpha.test(conveyancedeedAttestedByValue)) {
    conveyancedeedAttestedByError.textContent =
      "Attested By must only contain alphabets";
    conveyancedeedAttestedByError.style.display = "block";
    return false;
  } else {
    conveyancedeedAttestedByError.style.display = "none";
    return true;
  }
} */
...
function validateConveyanceOwnershipDoc() {
  if (conveyanceOwnershipDoc.files.length > 0) {
    ...
    conveyanceOwnershipDocError.textContent =
      "Owndership Document PDF is required";
    return false;
  }
}
...
function validateConveyanceAadharDoc() {
  if (conveyanceAadharDoc.files.length > 0) {
    ...
    conveyanceAadharDocError.textContent = "Adhaar PDF file is required";
    return false;
  }
}
...
function validateConveyancePanDoc() {
  if (conveyancePanDoc.files.length > 0) {
    ...
    conveyancePanDocError.textContent = "Pan Card PDF file is required";
    return false;
  }
}
...
/* document.addEventListener("DOMContentLoaded", function () {
  ...
  nocRegDate.setAttribute("max", today);
  conveyanceDateOfAttestaion.setAttribute("max", today);
}); */
