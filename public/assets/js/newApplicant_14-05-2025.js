...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function validateMuteSaleDeedRegno() {
    ...
    if (muteSaleDeedRegnoValue === "") {
      ...
      muteSaleDeedRegnoError.style.display = "block";
      return false;
    } else if (!/^\d+$/.test(muteSaleDeedRegnoValue)) {
      muteSaleDeedRegnoError.textContent = "Only numbers are allowed.";
      muteSaleDeedRegnoError.style.display = "block";
      return false;
    } else {
      muteSaleDeedRegnoError.style.display = "none";
  ...
  function validateMuteWillRegno() {
    ...
    if (muteWillRegnoValue === "") {
      ...
      return false;
    } else if (!/^\d+$/.test(muteWillRegnoValue)) {
      muteWillRegnoError.textContent = "Only numbers are allowed.";
      muteWillRegnoError.style.display = "block";
      return false;
    } else {
  ...
  function validateMuteRelinquishDeedRegNo() {
    ...
    if (muteRelinquishDeedRegNoValue === "") {
      ...
      return false;
    } else if (!/^\d+$/.test(muteRelinquishDeedRegNoValue)) {
      muteRelinquishDeedRegNoError.textContent =
  ...
  function validateMuteGiftDeedRegno() {
    ...
    if (muteGiftDeedRegnoValue === "") {
      ...
      return false;
    } else if (!/^[\d\s]+$/.test(muteGiftDeedRegnoValue)) {
      muteGiftDeedRegnoValue.textContent =
        "Gift deed registration number must be numeric.";
      muteGiftDeedRegnoValue.style.display = "block";
      return false;
    } else {
  ...
  // Main validation function for the form add by anil on 11-02-2025
  // function validateForm3MUT() {
  //   var isMutValidateForm3Valid = true; // Changed to use isMutValidateForm3Valid

  //   // Death Certificate Mutaition form step 3  add by anil on 17-02-2025 for validation
  //   var isDethCertificateMuteValid = validateMuteDethCertificate();
  //   var isDethDeceaseNameMuteValid = validateMuteDethDeceaseName();
  //   var isDethDateMuteValid = validateMuteDethDate();
  //   var isDethCertificateIssueDateMuteValid = validateMuteDethCertificateIssueDate();
  //   var isDethCertificateNumberMuteValid = validateMuteDethCertificateNumber();
  //   // Death Certificate Mutaition form step 3  add by anil on 17-02-2025 for validation

  //   // Sale deed Mutaition form step 3 add by anil on 17-02-2025 for validation
  //   var isSaleDeedMuteValid = validateMuteSaleDeed();
  //   var isSaleDeedRegnoMuteValid = validateMuteSaleDeedRegno();
  //   var isSaleDeedVolumeMuteValid = validateMuteSaleDeedVolume();
  //   var isSaleDeedBookNoMuteValid = validateMuteSaleDeedBookNo();
  //   var isSaleDeedFromMuteValid = validateMuteSaleDeedFrom();
  //   var isSaleDeedToMuteValid = validateMuteSaleDeedTo();
  //   var isSaleDeedRegDateMuteValid = validateMuteSaleDeedRegDate();
  //   var isSaleDeedRegOfficeNameMuteValid = validateMuteSaleDeedRegOfficeName();
  //   // Sale deed Mutaition form step 3 add by anil on 17-02-2025 for validation

  //   // Regd. Will deed Mutaition form step 3 add by anil on 18-02-2025 for validation
  //   var isWillRegdFileMuteValid = validateMuteWillRegdFile();
  //   var isWillTestatorNameMuteValid = validateMuteWillTestatorName();
  //   var isWillRegnoMuteValid = validateMuteWillRegno();
  //   var isWillVolumeMuteValid = validateMuteWillVolume();
  //   var isWillBookNoMuteValid = validateMuteWillBookNo();
  //   var isWillFromMuteValid = validateMuteWillFrom();
  //   var isWillToMuteValid = validateMuteWillTo();
  //   var isRegDateMuteValid = validateMuteWillRegDate();
  //   var isWillRegOfficeNameMuteValid = validateMuteWillRegOfficeName();
  //   // Regd. Will deed Mutaition form step 3 add by anil on 18-02-2025 for validation

  //   // Registered Relinquishment deed Mutaition form step 3 add by anil on 18-02-2025 for validation
  //   var isRelinquishDeedFileMuteValid = validateMuteRelinquishDeedFile();
  //   var isRelinquishDeedReleaserNameMuteValid = validateMuteRelinquishDeedReleaserName();
  //   var isRelinquishDeedRegNoMuteValid = validateMuteRelinquishDeedRegNo();
  //   var isRelinquishDeedVolumeMuteValid = validateMuteRelinquishDeedVolume();
  //   var isRelinquishDeedBooknoMuteValid = validateMuteRelinquishDeedBookno();
  //   var isRelinquishDeedFromMuteValid = validateMuteRelinquishDeedFrom();
  //   var isRelinquishDeedToMuteValid = validateMuteRelinquishDeedTo();
  //   var isRelinquishDeedRegdateMuteValid = validateMuteRelinquishDeedRegdate();
  //   var isRelinquishDeedRegnameMuteValid = validateMuteRelinquishDeedRegname();
  //   // Registered Relinquishment deed Mutaition form step 3 add by anil on 18-02-2025 for validation

  //   // Gift deed Mutaition form step 3 add by anil on 18-02-2025 for validation
  //   var isGiftDeedFileMuteValid = validateMuteGiftDeedFile();
  //   var isGiftDeedRegnoMuteValid = validateMuteGiftDeedRegno();
  //   var isGiftDeedVolumeMuteValid = validateMuteGiftDeedVolume();
  //   var isGiftDeedBooknoMuteValid = validateMuteGiftDeedBookno();
  //   var isGiftDeedFromMuteValid = validateMuteGiftDeedFrom();
  //   var isGiftDeedToMuteValid = validateMuteGiftDeedTo();
  //   var isGiftDeedRegdateMuteValid = validateMuteGiftDeedRegdate();
  //   var isGiftDeedRegOfficeNameMuteValid = validateMuteGiftDeedRegOfficeName();
  //   // Gift deed Mutaition form step 3 add by anil on 18-02-2025 for validation

  //   // Surviving Member Certificate Mutaition form step 3 add by anil on 18-02-2025 for validation
  //   var isSmcFileMuteValid = validateMuteSmcFile();
  //   var isSmcCertificateNoMuteisValid = validateMuteSmcCertificateNo();
  //   var isSmcDateOfIssueMuteValid = validateMuteSmcDateOfIssue();
  //   // Surviving Member Certificate Mutaition form step 3 add by anil on 18-02-2025 for validation

  //   // Sanction Building Plan Mutaition form step 3 add by anil on 18-02-2025 for validation
  //   var isSbpFileMuteValid = validateMuteSbpFile();
  //   var isSbpDateOfIssueMuteValid = validateMuteSbpDateOfIssue();
  //   // Sanction Building Plan Mutaition form step 3 add by anil on 18-02-2025 for validation

  //   var isAgreeConsentMutValid = validateAgreeConsentMut(); // Check if Terms & Conditions is accepted
  ...
  //     isDethDeceaseNameMuteValid &&
  //     isDethDateMuteValid &&
  //     isDethCertificateIssueDateMuteValid &&
  //     isDethCertificateNumberMuteValid &&

  //     // Sale deed Mutaition form step 3 add by anil on 17-02-2025 for validation
  //     isSaleDeedMuteValid &&
  //     isSaleDeedRegnoMuteValid &&
  //     isSaleDeedVolumeMuteValid &&
  //     isSaleDeedBookNoMuteValid &&
  //     isSaleDeedFromMuteValid &&
  //     isSaleDeedToMuteValid &&
  //     // isSaleDeedRangeMuteValid &&
  //     isSaleDeedRegDateMuteValid &&
  //     isSaleDeedRegOfficeNameMuteValid &&
  //     // Sale deed Mutaition form step 3 add by anil on 17-02-2025 for validation

  //     // Regd. Will deed Mutaition form step 3 add by anil on 18-02-2025 for validation
  //     isWillRegdFileMuteValid &&
  //     isWillTestatorNameMuteValid &&
  //     isWillRegnoMuteValid &&
  //     isWillVolumeMuteValid &&
  //     isWillBookNoMuteValid &&
  //     isWillFromMuteValid &&
  //     isWillToMuteValid &&
  //     isRegDateMuteValid &&
  //     isWillRegOfficeNameMuteValid &&
  //     // Regd. Will deed Mutaition form step 3 add by anil on 18-02-2025 for validation

  //     // Registered Relinquishment deed Mutaition form step 3 add by anil on 18-02-2025 for validation
  //     isRelinquishDeedFileMuteValid &&
  //     isRelinquishDeedReleaserNameMuteValid &&
  //     isRelinquishDeedRegNoMuteValid &&
  //     isRelinquishDeedVolumeMuteValid &&
  //     isRelinquishDeedBooknoMuteValid &&
  //     isRelinquishDeedFromMuteValid &&
  //     isRelinquishDeedToMuteValid &&
  //     isRelinquishDeedRegdateMuteValid &&
  //     isRelinquishDeedRegnameMuteValid &&
  //     // Registered Relinquishment deed Mutaition form step 3 add by anil on 18-02-2025 for validation

  //     // Gift deed Mutaition form step 3 add by anil on 18-02-2025 for validation
  //     isGiftDeedFileMuteValid &&
  //     isGiftDeedRegnoMuteValid &&
  //     isGiftDeedVolumeMuteValid &&
  //     isGiftDeedBooknoMuteValid &&
  //     isGiftDeedFromMuteValid &&
  //     isGiftDeedToMuteValid &&
  //     isGiftDeedRegdateMuteValid &&
  //     isGiftDeedRegOfficeNameMuteValid &&
  //     // Gift deed Mutaition form step 3 add by anil on 18-02-2025 for validation

  //     // Surviving Member Certificate Mutaition form step 3 add by anil on 18-02-2025 for validation
  //     isSmcFileMuteValid &&
  //     isSmcCertificateNoMuteisValid &&
  //     isSmcDateOfIssueMuteValid &&
  //     // Surviving Member Certificate Mutaition form step 3 add by anil on 18-02-2025 for validation

  //     // Sanction Building Plan Mutaition form step 3 add by anil on 18-02-2025 for validation
  //     isSbpFileMuteValid &&
  //     isSbpDateOfIssueMuteValid &&
  //     // Sanction Building Plan Mutaition form step 3 add by anil on 18-02-2025 for validation

  //     isAgreeConsentMutValid
  //   )
