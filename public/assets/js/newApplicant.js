        ...
        .then(function (response) {
          if (response.status) {
            ...
            if (response.data.details.isIndian == 1) {
              ...
              $("#nocdocType").val(varDocType);
              $("#nocdocTypeNumber").val(
        ...
        .then(function (response) {
          if (response.status) {
            ...
            if (response.data.details.isIndian == 1) {
              ...
              $("#convdocType").val(varDocType);
              $("#convdocTypeNumber").val(
                decryptString(response.data.details.documentTypeNumber)
              );
            }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var lucPhotoOptional = document.getElementById("lucphotooptional");
  ...
  var lucPhotoOptionalError = document.getElementById("lucphotooptionalError");
  ...
  function validateLUCPhotoOptional() {
    if (lucPhotoOptional.files.length > 0) {
      var file = lucPhotoOptional.files[0];
      if (file.size > 5 * 1024 * 1024) {
        lucPhotoOptionalError.textContent = "File size must be less than 5 MB.";
        return false;
      } else if (!file.name.endsWith(".pdf")) {
        lucPhotoOptionalError.textContent = "Only PDF file is allowed.";
        return false;
      } else {
        lucPhotoOptionalError.textContent = "";
        return true;
      }
    } else {
  ...
  function validateForm2DOA() {
    ...
    var isPaymentReceiptValidDoa = validatePaymentReceiptDoa();
  ...
  function validatePaymentReceiptDoa() {
    if (PaymentReceipt.files.length > 0) {
      ...
      if (file.size > 5 * 1024 * 1024) {
        PaymentReceiptError.textContent = "File size must be less than 5 MB.";
        return false;
      } else if (!file.name.endsWith(".pdf")) {
        PaymentReceiptError.textContent = "Only PDF files are allowed.";
        return false;
      } else {
      ...
      if (PaymentReceipt.getAttribute("data-should-validate") == 1) {
        return true;
      }
  ...
  function validateColoredPhotographOfPropertyDoa() {
    if (ColoredPhotographOfProperty.files.length > 0) {
      var file = ColoredPhotographOfProperty.files[0];
      if (file.size > 5 * 1024 * 1024) {
      ...
      if (
        ColoredPhotographOfProperty.getAttribute("data-should-validate") == 1
      ) {
        return true;
      }
      ColoredPhotographOfPropertyError.textContent =
  ...
  function validateIndemnityBondDoa() {
  ...
  function validateDoaOtherDoc() {
    ...
    if (otherDocInput.files.length > 0) {
      ...
      if (file.size > 5 * 1024 * 1024) {
        otherDocError.textContent = "File size must be less than 5 MB.";
        return false;
      } else if (!file.name.toLowerCase().endsWith(".pdf")) {
        otherDocError.textContent = "Only PDF files are allowed.";
        return false;
      } else {
        otherDocError.textContent = "";
        return true;
      }
    } else {
      // No file selected - no validation needed
      otherDocError.textContent = "";
      return true;
    }
  }
  ...
  var convDocumentType = document.getElementById("convDocumentType");
  var convDocumentTypeError = document.getElementById("convDocumentTypeError");
  var convNriUploadDocument = document.getElementById("convNriUploadDocument");
  var convNriUploadDocumentError = document.getElementById(
    "convNriUploadDocumentError"
  );
  var convDocumentTypeNumber = document.getElementById(
    "convDocumentTypeNumber"
  );
  var convDocumentTypeNumberError = document.getElementById(
    "convDocumentTypeNumberError"
  );
  ...
  function validateConvDocumentType() {
    var validateConvDocumentTypeValue = convDocumentType.value.trim();

    if (validateConvDocumentTypeValue === "") {
      convDocumentTypeError.textContent = "Document type is required.";
      convDocumentTypeError.style.display = "block";
      return false;
    } else {
      convDocumentTypeError.style.display = "none";
      return true;
    }
  }

  function validateConvNriUploadDocument() {
    if (convNriUploadDocument.files.length > 0) {
      var file = convNriUploadDocument.files[0];
      if (file.size > 5 * 1024 * 1024) {
        convNriUploadDocumentError.textContent =
          "File size must be less than 5 MB.";
        return false;
      } else if (!file.name.endsWith(".pdf")) {
        convNriUploadDocumentError.textContent = "Only PDF files are allowed.";
        return false;
      } else {
        convNriUploadDocumentError.textContent = "";
        return true;
      ...
      if (convNriUploadDocument.getAttribute("data-should-validate") == 1) {
        return true;
      }
      convNriUploadDocumentError.textContent =
        "Upload document PDF is required.";
      return false;
    }
  }

  function validateConvDocumentTypeNumber() {
    var convDocumentTypeNumberValue = convDocumentTypeNumber.value.trim();
    if (convDocumentTypeNumberValue === "") {
      convDocumentTypeNumberError.textContent =
        "Document type number is required.";
      convDocumentTypeNumberError.style.display = "block";
      return false;
    }

    // Check length: minimum 6 and maximum 12 characters
    if (
      convDocumentTypeNumberValue.length < 6 ||
      convDocumentTypeNumberValue.length > 12
    ) {
      convDocumentTypeNumberError.textContent =
        "Document type number must be between 6 and 12 characters.";
      convDocumentTypeNumberError.style.display = "block";
      return false;
    }

    var convContructionAlpha = /^[A-Za-z0-9\s.-]+$/;
    if (!convContructionAlpha.test(convDocumentTypeNumberValue)) {
      convDocumentTypeNumberError.textContent =
        "Document type number must contain only letters, numbers, spaces, dots, and hyphens.";
      convDocumentTypeNumberError.style.display = "block";
      return false;
    } else {
      convDocumentTypeNumberError.style.display = "none";
      return true;
    }
  }
  ...
  function validateForm2Conv() {
    ...
    if (isApplicantIndian == 1) {
      ...
      var isConvDocumentType = validateConvDocumentType();
      var isConvNriUploadDocument = validateConvNriUploadDocument();
      var isConvDocumentTypeNumber = validateConvDocumentTypeNumber();
      return (
        isMandatoryConvDocumentsFormValid &&
        // ** commented by anil for not in use on 06-10-2025 **
        // isConvAttestedLetterFileValid &&
  ...
  function validateMuteDethCertificate() {
    if (!muteDethCertificate || !muteDethCertificateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteDethCertificate.offsetParent || muteDethCertificate.disabled) {
      return true;
    }
  ...
  function validateMuteDethDeceaseName() {
    if (!muteDethDeceaseName || !muteDethDeceaseNameError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteDethDeceaseName.offsetParent || muteDethDeceaseName.disabled) {
      return true;
    }
  ...
  function validateMuteDethDate() {
    if (!muteDethDate || !muteDethDateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteDethDate.offsetParent || muteDethDate.disabled) {
      return true;
    }
  ...
  function validateMuteDethCertificateIssueDate() {
    if (!muteDethCertificateIssueDate || !muteDethCertificateIssueDateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteDethCertificateIssueDate.offsetParent ||
      muteDethCertificateIssueDate.disabled
    ) {
      return true;
    }
  ...
  function validateMuteDethCertificateNumber() {
    if (!muteDethCertificateNumber || !muteDethCertificateNumberError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteDethCertificateNumber.offsetParent ||
      muteDethCertificateNumber.disabled
    ) {
      return true;
    }
  ...
  function validateMuteSaleDeed() {
    if (!muteSaleDeed || !muteSaleDeedError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeed.offsetParent || muteSaleDeed.disabled) {
      return true;
    }
  ...
  function validateMuteSaleDeedRegno() {
    if (!muteSaleDeedRegno || !muteSaleDeedRegnoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeedRegno.offsetParent || muteSaleDeedRegno.disabled) {
      return true;
    }
  ...
  function validateMuteSaleDeedVolume() {
    if (!muteSaleDeedVolume || !muteSaleDeedVolumeError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeedVolume.offsetParent || muteSaleDeedVolume.disabled) {
      return true;
    }
  ...
  function validateMuteSaleDeedBookNo() {
    if (!muteSaleDeedBookNo || !muteSaleDeedBookNoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeedBookNo.offsetParent || muteSaleDeedBookNo.disabled) {
      return true;
    }
  ...
  function validateMuteSaleDeedFrom() {
    if (!muteSaleDeedFrom || !muteSaleDeedFromError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeedFrom.offsetParent || muteSaleDeedFrom.disabled) {
      return true;
    }
  ...
  function validateMuteSaleDeedTo() {
    if (!muteSaleDeedTo || !muteSaleDeedToError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeedTo.offsetParent || muteSaleDeedTo.disabled) {
      return true;
    }
  ...
  function validateMuteSaleDeedRegDate() {
    if (!muteSaleDeedRegDate || !muteSaleDeedRegDateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSaleDeedRegDate.offsetParent || muteSaleDeedRegDate.disabled) {
      return true;
    }
  ...
  function validateMuteWillRegdFile() {
    if (!muteWillRegdFile || !muteWillRegdFileError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillRegdFile.offsetParent || muteWillRegdFile.disabled) {
      return true;
    }
  ...
  function validateMuteWillTestatorName() {
    if (!muteWillTestatorName || !muteWillTestatorNameError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillTestatorName.offsetParent || muteWillTestatorName.disabled) {
      return true;
    }
  ...
  function validateMuteWillRegno() {
    if (!muteWillRegno || !muteWillRegnoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillRegno.offsetParent || muteWillRegno.disabled) {
      return true;
    }
  ...
  function validateMuteWillVolume() {
    if (!muteWillVolume || !muteWillVolumeError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillVolume.offsetParent || muteWillVolume.disabled) {
      return true;
    }
  ...
  function validateMuteWillBookNo() {
    if (!muteWillBookNo || !muteWillBookNoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillBookNo.offsetParent || muteWillBookNo.disabled) {
      return true;
    }
  ...
  function validateMuteWillFrom() {
    if (!muteWillFrom || !muteWillFromError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillFrom.offsetParent || muteWillFrom.disabled) {
      return true;
    }
  ...
  function validateMuteWillTo() {
    if (!muteWillTo || !muteWillToError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillTo.offsetParent || muteWillTo.disabled) {
      return true;
    }
  ...
  function validateMuteWillRegDate() {
    if (!muteWillRegDate || !muteWillRegDateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillRegDate.offsetParent || muteWillRegDate.disabled) {
      return true;
    }
  ...
  function validateMuteWillRegOfficeName() {
    if (!muteWillRegOfficeName || !muteWillRegOfficeNameError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteWillRegOfficeName.offsetParent || muteWillRegOfficeName.disabled) {
      return true;
    }
  ...
  function validateMuteUnregdWillFile() {
    if (!muteUnregdWillFile || !muteUnregdWillFileError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteUnregdWillFile.offsetParent || muteUnregdWillFile.disabled) {
      return true;
    }
  ...
  function validateMuteUnregdWillTestatorName() {
    if (!muteUnregdWillTestatorName || !muteUnregdWillTestatorNameError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteUnregdWillTestatorName.offsetParent ||
      muteUnregdWillTestatorName.disabled
    ) {
      return true;
    }
  ...
  function validateMuteUnregdWillDate() {
    if (!muteUnregdWillDate || !muteUnregdWillDateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteUnregdWillDate.offsetParent || muteUnregdWillDate.disabled) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedFile() {
    if (!muteRelinquishDeedFile || !muteRelinquishDeedFileError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedFile.offsetParent ||
      muteRelinquishDeedFile.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedReleaserName() {
    if (
      !muteRelinquishDeedReleaserName ||
      !muteRelinquishDeedReleaserNameError
    ) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedReleaserName.offsetParent ||
      muteRelinquishDeedReleaserName.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedRegNo() {
    if (!muteRelinquishDeedRegNo || !muteRelinquishDeedRegNoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedRegNo.offsetParent ||
      muteRelinquishDeedRegNo.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedVolume() {
    ...
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedVolume.offsetParent ||
      muteRelinquishDeedVolume.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedBookno() {
    if (!muteRelinquishDeedBookno || !muteRelinquishDeedBooknoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedBookno.offsetParent ||
      muteRelinquishDeedBookno.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedFrom() {
    if (!muteRelinquishDeedFrom || !muteRelinquishDeedFromError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedFrom.offsetParent ||
      muteRelinquishDeedFrom.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedTo() {
    if (!muteRelinquishDeedTo || !muteRelinquishDeedToError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteRelinquishDeedTo.offsetParent || muteRelinquishDeedTo.disabled) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedRegdate() {
    if (!muteRelinquishDeedRegdate || !muteRelinquishDeedRegdateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedRegdate.offsetParent ||
      muteRelinquishDeedRegdate.disabled
    ) {
      return true;
    }
  ...
  function validateMuteRelinquishDeedRegname() {
    if (!muteRelinquishDeedRegname || !muteRelinquishDeedRegnameError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteRelinquishDeedRegname.offsetParent ||
      muteRelinquishDeedRegname.disabled
    ) {
      return true;
    }
  ...
  function validateMuteGiftDeedFile() {
    if (!muteGiftDeedFile || !muteGiftDeedFileError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedFile.offsetParent || muteGiftDeedFile.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedRegno() {
    if (!muteGiftDeedRegno || !muteGiftDeedRegnoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedRegno.offsetParent || muteGiftDeedRegno.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedVolume() {
    if (!muteGiftDeedVolume || !muteGiftDeedVolumeError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedVolume.offsetParent || muteGiftDeedVolume.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedBookno() {
    if (!muteGiftDeedBookno || !muteGiftDeedBooknoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedBookno.offsetParent || muteGiftDeedBookno.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedFrom() {
    if (!muteGiftDeedFrom || !muteGiftDeedFromError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedFrom.offsetParent || muteGiftDeedFrom.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedTo() {
    if (!muteGiftDeedTo || !muteGiftDeedToError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedTo.offsetParent || muteGiftDeedTo.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedRegdate() {
    if (!muteGiftDeedRegdate || !muteGiftDeedRegdateError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteGiftDeedRegdate.offsetParent || muteGiftDeedRegdate.disabled) {
      return true;
    }
  ...
  function validateMuteGiftDeedRegOfficeName() {
    if (!muteGiftDeedRegOfficeName || !muteGiftDeedRegOfficeNameError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (
      !muteGiftDeedRegOfficeName.offsetParent ||
      muteGiftDeedRegOfficeName.disabled
    ) {
      return true;
    }
  ...
  function validateMuteSmcFile() {
    if (!muteSmcFile || !muteSmcFileError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSmcFile.offsetParent || muteSmcFile.disabled) {
      return true;
    }
  ...
  function validateMuteSmcCertificateNo() {
    if (!muteSmcCertificateNo || !muteSmcCertificateNoError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSmcCertificateNo.offsetParent || muteSmcCertificateNo.disabled) {
      return true;
    }
  ...
  function validateMuteSmcDateOfIssue() {
    if (!muteSmcDateOfIssue || !muteSmcDateOfIssueError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!muteSmcDateOfIssue.offsetParent || muteSmcDateOfIssue.disabled) {
      return true;
    }
  ...
  function validateMutePropateFile() {
    if (!mutePropateFile || !mutePropateFileError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!mutePropateFile.offsetParent || mutePropateFile.disabled) {
      return true;
    }
  ...
  function validateAgreeConsentMut() {
    if (!MutAgreeConsent || !MutAgreeconsentError) {
      return true;
    }
    // 🟡 Skip validation if input is hidden or disabled (likely in edit mode)
    if (!MutAgreeConsent.offsetParent || MutAgreeConsent.disabled) {
      return true;
    }
  ...
  function mutation(propertyid, propertyStatus, callback) {
    ...
    mutAadharApp = encryptString(mutAadharApp);
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        //         `input[name='coapplicant[${id.index - 1}][id]']`
        //       );
        //       console.log(coApplicantInput);
  ...
  Array.from(editFinalSubmit).forEach((btn) => {
    btn.addEventListener("click", function (event) {
      ...
      // ✅ Run validateForm3MUT() ONLY for SUB_MUT
      const isMutValid =
        applicationType === "SUB_MUT" ? validateForm3MUT() : true;

      console.log("applicationType:", applicationType);
      console.log("isEditValid:", isEditValid);
      console.log("isMutValid:", isMutValid);

      if (isEditValid && isMutValid) {
        btn.textContent = "Submitting...";
        btn.disabled = true;
...
function validateMixedLUCSection() {
  let isValid = true;

  // Clear previous errors
  // $("#luc_TBUA_error").empty();
  // $("#luc_BUAC_error").empty();

  const isMixedLUCChecked = $("#mixed_LUC").is(":checked");
  // ✅ If checkbox is NOT checked, hide .estimate if it's visible and skip validation
  if (!isMixedLUCChecked) {
    if (!$(".estimate").hasClass("d-none")) {
      $(".estimate").addClass("d-none");
    }
  ...
  // Validation: Total Built-Up Area
  if (tbuac <= 0) {
    $("#luc_TBUA_error").html("Total built-up area is required.");
    isValid = false;
  } else if (tbuac > landArea) {
    $("#luc_TBUA_error").html(
      `Total built-up area cannot be more than land size ${landArea} Sq.m.`
    );
    isValid = false;
  ...
  // Validation: Estimated Charges must be calculated
  if (!estimatedChargesText || estimatedChargesText === "₹ 0.0") {
    alert("Please first 'Get Estimated Charges' to calculate the charges.");
    isValid = false;
  }
...
// added new input validation by anil on 13-10-2025
var conveyanceSaledeed = document.getElementById("saledeed");
var conveyanceSaledeedError = document.getElementById("saledeedError");
...
var nocDocumentType = document.getElementById("nocDocumentType");
var nocDocumentTypeError = document.getElementById("nocDocumentTypeError");
var nocNriUploadDocument = document.getElementById("nocNriUploadDocument");
var nocNriUploadDocumentError = document.getElementById(
  "nocNriUploadDocumentError"
);
var nocDocumentTypeNumber = document.getElementById("nocDocumentTypeNumber");
var nocDocumentTypeNumberError = document.getElementById(
  "nocDocumentTypeNumberError"
);

function validateForm2Noc() {
  // added new input validation by anil on 13-10-2025
  var isValidateConveyanceLeaseDeedFile = validateConveyanceLeaseDeedFile();
  ...
  if (isApplicantIndian == 1) {
    ...
    return (
      ...
      isValidateConveyanceElectricityBill &&
      isValidateConveyanceUndertakingregLand &&
    ...
    var isNocDocumentType = validateNocDocumentType();
    var isNocNriUploadDocument = validateNocNriUploadDocument();
    var isNocDocumentTypeNumber = validateNocDocumentTypeNumber();
    return (
      isValidateConveyanceLeaseDeedFile &&
      isValidateConveyanceDeedFile &&
      isConveyanceOwnershipDoc &&
...
function validateConveyanceLeaseDeedFile() {
  if (conveyanceLeasedeed.files.length > 0) {
    ...
    if (conveyanceLeasedeed.getAttribute("data-should-validate") == 1) {
      return true;
    }
    conveyanceLeasedeedError.textContent = "Lease deed PDF is required.";
    return false;
  }
}
// end new input validation by anil on 13-10-2025
...
// added new input validation by anil on 13-10-2025
function validateConveyanceSaledeedDoc() {
  if (conveyanceSaledeed.files.length > 0) {
    var file = conveyanceSaledeed.files[0];
    if (file.size > 5 * 1024 * 1024) {
      conveyanceSaledeedError.textContent = "File size must be less than 5 MB.";
      return false;
    } else if (!file.name.endsWith(".pdf")) {
      conveyanceSaledeedError.textContent = "Only PDF files are allowed.";
      return false;
    } else {
      conveyanceSaledeedError.textContent = "";
      return true;
    }
  } else {
    if (conveyanceSaledeed.getAttribute("data-should-validate") == 1) {
      return true;
    }
    conveyanceSaledeedError.textContent = "Sale deed PDF is required.";
    return false;
  }
}
// end new input validation by anil on 13-10-2025
...
// added new input validation by anil on 13-10-2025
function validateConveyanceSubmutDone() {
  if (conveyanceSubmutDone.files.length > 0) {
    var file = conveyanceSubmutDone.files[0];
    if (file.size > 5 * 1024 * 1024) {
      conveyanceSubmutDoneError.textContent =
        "File size must be less than 5 MB.";
      return false;
    } else if (!file.name.endsWith(".pdf")) {
      conveyanceSubmutDoneError.textContent = "Only PDF files are allowed.";
      return false;
    } else {
      conveyanceSubmutDoneError.textContent = "";
      return true;
    ...
    if (conveyanceSubmutDone.getAttribute("data-should-validate") == 1) {
      return true;
    }
    conveyanceSubmutDoneError.textContent =
      "Substitution/Mutation document PDF is required.";
    return false;
  }
}

function validateConveyancePropPhotodocFile() {
  if (conveyancepropPhotodocFile.files.length > 0) {
    var file = conveyancepropPhotodocFile.files[0];
    if (file.size > 5 * 1024 * 1024) {
    ...
    if (conveyancepropPhotodocFile.getAttribute("data-should-validate") == 1) {
      return true;
    }
    conveyancepropPhotodocFileError.textContent =
      "Photo of the property PDF is required.";
    return false;
  }
}

function validateConveyanceElectricityBill() {
  if (conveyanceElectricitybill.files.length > 0) {
    var file = conveyanceElectricitybill.files[0];
    if (file.size > 5 * 1024 * 1024) {
    ...
    if (conveyanceElectricitybill.getAttribute("data-should-validate") == 1) {
      return true;
    }
    conveyanceElectricitybillError.textContent =
      "Latest electricity bill document PDF is required.";
    return false;
  }
}

function validateConveyanceUndertakingregLand() {
  if (conveyanceUndertakingregLand.files.length > 0) {
    var file = conveyanceUndertakingregLand.files[0];
    if (file.size > 5 * 1024 * 1024) {
    ...
    conveyanceUndertakingregLandError.textContent =
      "Undertaking document PDF is required.";
    return false;
  }
}
// end new input validation by anil on 13-10-2025
...
function validateNocDocumentType() {
  var validateNocDocumentTypeValue = nocDocumentType.value.trim();

  if (validateNocDocumentTypeValue === "") {
    nocDocumentTypeError.textContent = "Proof of possession is required.";
    nocDocumentTypeError.style.display = "block";
    return false;
  } else {
    nocDocumentTypeError.style.display = "none";
    return true;
  }
}

function validateNocNriUploadDocument() {
  if (nocNriUploadDocument.files.length > 0) {
    var file = nocNriUploadDocument.files[0];
    if (file.size > 5 * 1024 * 1024) {
      nocNriUploadDocumentError.textContent =
        "File size must be less than 5 MB.";
      return false;
    } else if (!file.name.endsWith(".pdf")) {
      nocNriUploadDocumentError.textContent = "Only PDF files are allowed.";
      return false;
    } else {
      nocNriUploadDocumentError.textContent = "";
      return true;
    ...
    if (nocNriUploadDocument.getAttribute("data-should-validate") == 1) {
      return true;
    }
    nocNriUploadDocumentError.textContent =
      "Proof of possession PDF is required.";
...
function validateNocDocumentTypeNumber() {
  var nocDocumentTypeNumberValue = nocDocumentTypeNumber.value.trim();
  if (nocDocumentTypeNumberValue === "") {
    nocDocumentTypeNumberError.textContent =
      "Document type number is required.";
    nocDocumentTypeNumberError.style.display = "block";
    return false;
  }

  // Check length: minimum 6 and maximum 12 characters
  if (
    nocDocumentTypeNumberValue.length < 6 ||
    nocDocumentTypeNumberValue.length > 12
  ) {
    nocDocumentTypeNumberError.textContent =
      "Document type number must be between 6 and 12 characters.";
    nocDocumentTypeNumberError.style.display = "block";
  ...
  var convContructionAlpha = /^[A-Za-z0-9\s.-]+$/;
  if (!convContructionAlpha.test(nocDocumentTypeNumberValue)) {
    nocDocumentTypeNumberError.textContent =
      "Document type number must contain only letters, numbers, spaces, dots, and hyphens.";
    nocDocumentTypeNumberError.style.display = "block";
    return false;
  } else {
    nocDocumentTypeNumberError.style.display = "none";
    return true;
  }
}
...
function validatePowerAttorney(stepAttr) {
  ...
  if (!appPowerAttorney || !appPowerAttorneyError) {
