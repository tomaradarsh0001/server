document.addEventListener("DOMContentLoaded", function() {
  ...
  $('input[id^="freeHoldFormYes"]').on('change', function(){
    debugger;
    var id = $(this).attr('id');
    var index = parseInt(id.replace('freeHoldFormYes', ''), 10);
        ...
        if(isChecked){
          freeHoldContainer.show(); // Show the div if checkbox is checked
        }
        else{
          freeHoldContainer.hide(); // Hide the div if checkbox is not checked
        }
    });
    ...
    if(!landusechange.checked) {
      ...
      if (validateForm21()) {
        stepper3.next()
          ...
          // =================================================== End ================================================================
          miscellDetailsHtml = miscellDetailsHtml + '<div class="col-12 col-lg-12"><h4 class="inspection_details">Detail '+ (i+1) +'</h4><div class="align-items-center d-flex"><h6 class="mb-0 mr-2">GR Revised Ever</h6><div class="form-check mr-2"><input class="form-check-input" id="GRFormYes" name="GR['+ (i+1) +']" type="radio" value="1"><label class="form-check-label" for="GRFormYes"><h6 class="mb-0">Yes</h6></label></div><div class="form-check"><input class="form-check-input" id="GRFormNo" name="GR['+ (i+1) +']" type="radio" value="0"><label class="form-check-label" for="GRFormNo"><h6 class="mb-0">No</h6></label></div></div></div><div class="col-lg-12"><div class="GR-container" id="GRContainer" style="display:none"><div class="col-12 col-lg-4"><label class="form-label" for="GRrevisedDate">Date</label><input class="form-control" id="GRrevisedDate" name="gr_revised_date['+ (i+1) +']" type="date"></div></div></div><div class="col-12 col-lg-12"><div class="align-items-center d-flex"><h6 class="mb-0 mr-2">Supplementary Lease Deed Executed</h6><div class="form-check mr-2"><input class="form-check-input" id="SupplementaryFormYes" name="Supplementary['+ (i+1) +']" type="radio" value="1"><label class="form-check-label" for="SupplementaryFormYes"><h6 class="mb-0">Yes</h6></label></div><div class="form-check"><input class="form-check-input" id="SupplementaryFormNo" name="Supplementary['+ (i+1) +']" type="radio" value="0"><label class="form-check-label" for="SupplementaryFormNo"><h6 class="mb-0">No</h6></label></div></div></div><div class="col-lg-12"><div class="row Supplementary-container" id="SupplementaryContainer" style="display:none"><div class="row"><div class="col-12 col-lg-6"><label class="form-label" for="SupplementaryDate">Date</label><input class="form-control" id="SupplementaryDate" name="supplementary_date['+ (i+1) +']" type="date"></div></div></div></div><div class="col-12 col-lg-12"><div class="align-items-center d-flex"><h6 class="mb-0 mr-2">Re-entered</h6><div class="form-check mr-2"><input class="form-check-input" id="ReenteredFormYes" name="Reentered['+ (i+1) +']" type="radio" value="1"><label class="form-check-label" for="ReenteredFormYes"><h6 class="mb-0">Yes</h6></label></div><div class="form-check"><input class="form-check-input" id="ReenteredFormNo" name="Reentered['+ (i+1) +']" type="radio" value="0"><label class="form-check-label" for="ReenteredFormNo"><h6 class="mb-0">No</h6></label></div></div></div><div class="col-lg-12"><div class="row Reentered-container" id="ReenteredContainer" style="display:none"><div class="col-12 col-lg-4"><label class="form-label" for="reentryDate">Date of re-entry</label><input class="form-control" id="reentryDate" name="date_of_reentry['+ (i+1) +']" type="date"></div></div></div>'
...
var landTypeFormYes = document.getElementById('landTypeFormYes').value;
var landTypeFormOthersYes = document.getElementById('landTypeFormOthersYes').value;
// var landTypeFormNo = document.getElementById('landTypeFormNo').value;
// landTypeFormOthersYes

if (freeHoldFormYes.trim() !== '') {
    if (freeHoldFormYes.trim().toLowerCase() === 'yes') {
        ...
        // ========================================================== Validation Required =====================================
          ...
          if (isValid) {
            ...
            // You can display a message to the user indicating validation errors
        }
  // =================================================================== End ============================================
        // End
    }
