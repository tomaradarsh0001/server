  ...
  $("#IndsubmitButton").click(async function (d) {
    ...
    (function () {
      ...
      if ((ownerValid === false) || (leaseValid === false)) {
          ...
          if (ownerValid === false && eField === null) eField = _;
          else if (leaseValid === false && eField === null) eField = O;
      }

      // added by anil new fucntion on 10-11-2025
      if (!isValid) {
          if (ownerValid !== true && eField === null) eField = _;
          else if (leaseValid !== true && eField === null) eField = O;
          return false;
      }
      ...
      M.is(":checked")
        ...
        : (M.addClass("required"),
          ...
          (r = !1));
          if (eField === null) eField = M;
      // null !== e && e.focus();
      if (eField !== null) eField.focus();
      // null !== eField && eField.focus();
      ...
      // return formIsValid && r && fileSectionValid && N && T; by anil on 10-10-2025
      // return formIsValid && r ; commented by anil on 14-10-2025
